export interface IMiniGame {
    ...
    isDevTool: boolean;
    isLandscape: boolean;
    orientation: import('@pal/screen-adapter').Orientation;
...
export type AccelerometerChangeCallback = (res: AccelerometerData) => void;
export declare interface AccelerometerData {
    x: number,
    y: number,
    z: number,
}
...
export declare interface SafeArea {
    left: number;
    right: number;
    top: number;
    bottom: number;
...
export declare class InnerAudioContext {
    src: string;
    startTime: number;
    autoplay: boolean;
    loop: boolean;
