...
<div class="particle-system-component">
    <div class="content">
        ...
        <ui-section key="useNoise" autoExpand cache-expand="particle-system-useNoise">
            ...
            <ui-prop type="dump" key="noiseAbs" disableflag="!useNoise"></ui-prop>
            <ui-prop type="dump" key="noiseAmplitude" disableflag="!useNoise"></ui-prop>
        </ui-section>
...
const excludeList = [
    ...
    'useNoise', 'noiseSpeedX', 'noiseSpeedY', 'noiseSpeedZ', 'noiseFrequency', 'noiseAbs', 'noiseAmplitude',
];
