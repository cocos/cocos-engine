module.exports = {
    components: {
        ...
        lod: {
            applyCameraSizeTip: 'Current Camera size is less or greater than its level limit, applying current minimum or maximum instead.<br/>Please reduce higher LOD levels\' or increase lower levels\' screen size and try again later.',
