module.exports = {
    ...
    assets: {
        ...
        javascript: {
            ...
            loadPluginInWebTip: 'When checked, this script will not be loaded/included until after the build is included in the Web Runtime Environment and the browser preview is available.',
            loadPluginInEditorTip: 'If other common scripts in the editor depend on the current script during the loading process, you need to manually enable this option.',
            loadPluginInNativeTip: 'Whether or not this script needs to be loaded/included in the emulator preview environment as well as after the native platform is built',
            loadPluginInMiniGame: 'Whether this script needs to be included in the mini-game platform build package',
            globalThisAliasTip: 'Once filled in, the Creator will encapsulate the necessary code to add a global variable of this name, so that third-party libraries provided as global variables can be better used across platforms',
        },
        scene: {
