module.exports = {
    ...
    assets: {
        ...
        spriteFrame: {
            ...
            editTip: 'Edit',
            meshType: 'Mesh Type',
            meshTypeTip: 'Type of the Sprite-frame mesh to generate',
            pixelsToUnit: 'Pixels To Unit',
            pixelsToUnitTip: 'How many pixels in the sprite-frame correspond to one unit in the world space',
            pivotX: 'Pivot X',
            pivotXTip: 'Sprite-frame X-axis position of the origin of the local coordinate system',
            pivotY: 'Pivot Y',
            pivotYTip: 'Sprite-frame Y-axis position of the origin of the local coordinate system',
        },
        texture: {
            anisotropy: 'Anisotropy',
            anisotropyTip: 'Anisotropy',
