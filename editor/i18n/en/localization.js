module.exports = {
    ...
    camera: {
        ...
        far: 'Far clipping distance of the camera',
        ...
        visibility: 'Visibility mask of the camera, based on what layer the target node is in,\nto filter out the models that don\'t need to render for this camera.',
        target_texture: 'Output render texture of the camera. Output directly to screen if not specified',
    },
    lights: {
