...
module.exports = {
    ...
    physics3d: {
        rigidbody: {
            group: 'Grouping of this rigid body',
            ...
            linearDamping: 'Used to decay the linear velocity, the larger the value, the faster the decay',
            angularDamping: 'Used to decay the angular velocity, the larger the value, the faster the decay',
        ...
        collider: {
            attached: 'The rigid body attached to the colliding body',
            ...
            sphere_radius: 'In the local coordinate system, the radius of the sphere',
            box_size: 'In the local coordinate system, the size of the box',
            ...
            capsule_direction: 'In the local coordinate system, the orientation of the capsule body',
            cone_radius: 'In the local coordinate system, the radius of the upper circular surface of the cone',
            cone_height: 'In the local coordinate system, the height of the cone in the corresponding axial direction',
            cone_direction: 'In the local coordinate system, the orientation of the cone',
            cylinder_radius: 'In the local coordinate system, the radius of the circular surface on the cylinder',
            cylinder_height: 'In the local coordinate system, the height of the cylinder in the corresponding axial direction',
            cylinder_direction: 'In the local coordinate system, the orientation of the cylinder',
            plane_normal: 'In the local coordinate system, the normal to the plane',
            plane_constant: 'In the local coordinate system, the distance of the plane moving along the normal from the origin',
        ...
        constant_force:{
            force: 'In the world coordinate system, the force exerted on a rigid body',
            localForce: 'In the local coordinate system, the force exerted on a rigid body',
