module.exports = {
    ...
    help: {
        cc: {
            ...
            UITransformComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-transform.html',
            SpriteComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/sprite.html',
            ...
            CanvasComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/canvas.html',
            ...
            UICoordinateTrackerComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-coordinate-tracker.html',
            AnimationComponent: 'https://docs.cocos.com/creator3d/manual/en/engine/animation/animation-component.html',
            SkeletalAnimationComponent: 'https://docs.cocos.com/creator3d/manual/en/engine/animation/skeletal-animation.html',
            AudioSourceComponent: 'https://docs.cocos.com/creator3d/manual/en/audio-system/overview.html',
            BillboardComponent: 'https://docs.cocos.com/creator3d/manual/en/particle-system/billboard-component.html',
            LineComponent: 'https://docs.cocos.com/creator3d/manual/en/particle-system/line-component.html',
            ParticleSystemComponent: 'https://docs.cocos.com/creator3d/manual/en/particle-system/main-module.html',
            ButtonComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/button.html',
            LabelComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/label.html',
            EditBoxComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/editbox.html',
            LayoutComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/layout.html',
            GraphicsComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/graphics.html',
            MaskComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/mask.html',
            ProgressBarComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/progress.html',
            LabelOutlineComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/label-outline.html',
            RichTextComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/richtext.html',
            ScrollBarComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/scrollbar.html',
            ScrollView: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/scrollview.html',
            SliderComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/slider.html',
            ToggleContainerComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/toggleContainer.html',
            ToggleComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/toggle.html',
            UIModelComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-model.html',
            WebviewComponent: '',
            WidgetComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/widget.html',
            UIReorderComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-reorder-component.html',
            PageViewIndicatorComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/pageviewindicator.html',
            PageViewComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/pageview.html',
            UIStaticBatchComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-static.html',
            UIOpacityComponent: 'https://docs.cocos.com/creator3d/manual/en/ui-system/components/editor/ui-opacity.html',
            BoxColliderComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-collider.html',
            SphereColliderComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-component.html',
            CapsuleColliderComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-component.html',
            CylinderColliderComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-component.html',
            MeshColliderComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-component.html',
            RigidBodyComponent: 'https://docs.cocos.com/creator3d/manual/en/physics/physics-rigidbody.html',
    ...
    help_url: {
        ...
        label: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/label/',
        canvas: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/canvas/',
        spine: 'http://www.cocos.com/docs/creator/components/spine.html',
        widget: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/widget/',
        button: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/button/',
        progressbar: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/progress/',
        mask: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/mask/',
        scrollview: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/scrollview/',
        scrollbar: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/scrollbar/',
        layout: 'http://cocos2d-x.org/docs/editors_and_tools/creator-chapters/components/layout/',
    ...
    model: {
        ...
        skinning_root: 'The skinning root, where the controlling AnimationComponent is located',
    },
    sprite: {
    ...
    particle: {
        ...
        capacity: 'The maximum number of particles a particle system can produce',
        start_color: 'Particle initial color',
        scale_space: 'Select scale coordinate system',
        start_size_3d: 'Whether to turn on the initial size of the particles in the XYZ axis respectively',
        start_size: 'Initial particle size',
        start_speed: 'Particle initial speed',
        start_rotation_3d: 'Whether to turn on the rotation angle of the particles in the XYZ axis respectively',
        start_rotation: 'Initial rotation angle of the particle',
        start_delay: 'The time to delay particle emission after the particle system starts operating',
        start_life_time: 'Particle Life Cycle',
        duration: 'Particle System Runtime',
        loop: 'Does the particle system loop',
        prewarm: 'When selected, the particle system will start playing in the state after the round has been played (only valid when loop playback is enabled)',
        simulation_space: 'The coordinate system that controls the particle coordinate calculation',
        simulation_speed: 'Control the update speed of the entire particle system',
        play_on_awake: 'Does the particle system automatically start playing after loading',
        gravity_modifier: 'The coefficient of gravity of a particle affected by gravity',
        rate_over_time: 'Number of particles emitted per second',
        rate_over_distance: 'The number of particles emitted per moving unit distance',
        bursts: 'Emitting a given number of particles at a point in time',
        color_module: 'Color module',
        shape_module: 'Launcher Module',
        size_module: 'Size module',
        speed_module: 'Speed module',
        force_module: 'Acceleration module',
        limit_module: 'Speed limit module',
        rotation_module: 'Rotation module',
        texture_module: 'Texture animation module',
        trail_module: 'Trailing module',
        renderer_module: 'Rendering module',
        culling: 'Whether to reject non-enable module data',
        billboard_texture: 'Billboard display of the paste',
        billboard_height: 'The height of the billboard',
        billboard_width: 'Width of billboard',
        billboard_rotation: 'The angle at which the billboard rotates around the center point',
        render_mode: 'Set particle generation mode',
        velocity_scale: 'Stretch the particle in the direction of motion by velocity when the particle is generated as StrecthedBillboard',
        length_scale: 'Stretch the particle in the direction of motion by the particle size when the particle is generated as StrecthedBillboard',
        mesh: 'A model of particle emission',
        particle_material: 'The material used by the particle',
        trail_material: 'Material used for trailing',
        use_gpu: 'Whether to enable GPU particles (the effect of the material needs to select builtin-particle-gpu)',
        line_texture: 'The paste displayed in the line segment',
        line_space: 'Which coordinate system is used for the coordinates of the points in the line segment, check the Use world coordinate system, do not check the Use local coordinate system',
        line_positions: 'Coordinates of each line segment endpoint',
        line_width: 'Line segment width, if a curve is used, indicates the change in the curve along the direction of the line segment',
        line_tile: 'Number of times the map is tiled',
        line_offset: 'Offset of map coordinates',
        line_color: 'Line segment color, if a gradient color is used, indicates a color gradient along the direction of the line segment',
        trail_mode: 'Particle forms a trailing effect on the motion of each particle',
        trail_life: 'The life cycle of trail',
        trail_distance: 'The shortest distance a particle can run per trailing node generated',
        trail_space: 'The coordinate system where the trail is located, World runs in the world coordinate system and Local runs in the local coordinate system',
        trail_exist: 'Does the trailing tail disappear with the particle',
        trail_texture: 'The spread of a texture on a trail, a Stretch texture overlaid on the whole trail, a Repeat texture overlaid on a section of trail',
        trail_width: 'Trailing width inherited from particle size',
        trail_ratio: 'Trailing width, proportional to particle size if inherited from the particle',
        trail_color: 'Does the trail color inherit from the particle',
        trail_gradient: 'The color of the trailing tail changes with the color of the trail own length',
        trail_time_gradient: 'Trail colour gradient over time',
        shape_position: 'Particle emitter position',
        shape_rotation: 'Particle emitter rotation angle',
        shape_scale: 'Particle emitter scale',
        shape_arc: 'Particle emitter emits in a sectoral range',
        shape_angle: 'The angle between the axis of the cone and the busbar \n determines the degree of opening and closing of the cone launcher',
        shape_type: 'Particle emitter type',
        shape_emit: 'From which part of the emitter the particle is emitted',
        shape_dir: 'Determines the direction in which the particle will move based on its initial orientation',
        shape_random: 'Random setting of particle generation direction',
        shape_spherical: 'Indicates the interpolation of the current emission direction with the direction of the current position to the node center line',
        shape_amount: 'Particle generation position is set randomly (setting this value to non-zero will make the particle generation position out of the generator size range)',
        shape_radius: 'Particle emitter radius',
        shape_thickness: 'Radius thickness',
        shape_arc_mode: 'The way a particle is emitted in the fan range',
        shape_arc_spread: 'Controls discrete intervals around arcs that may produce particles',
        shape_arc_speed: 'The speed at which a particle is emitted along its circumference',
        shape_length: 'The axis length of the top section of the cone from the bottom determines the height of the cone launcher',
        shape_box: 'Particle emitter emission location (for Box type particle emitters)',
        force_x: 'Acceleration component in the X-axis direction',
        force_y: 'The component of acceleration in the Y-axis',
        force_z: 'The component of acceleration in the Z-axis direction',
        force_space: 'Coordinates used for acceleration calculation',
        limit_x: 'Lower limit of speed in the X-axis direction',
        limit_y: 'Lower limit of speed in the Y-axis direction',
        limit_z: 'Lower limit of speed in the Z-axis direction',
        limit_v: 'Lower speed limit',
        limit_dampen: 'Interpolation of current speed with lower speed limit',
        limit_separate: 'Whether the three axes are limited separately',
        limit_space: 'The coordinate system used to calculate the lower speed limit',
        rotation_x: 'Set rotation around X-axis',
        rotation_y: 'Set rotation around Y-axis',
        rotation_z: 'Set rotation around Z-axis',
        rotation_separate: 'If or not the three axes are separated to set rotation (not supported for now)',
        size_x: 'Define a curve to determine the size change in the X-axis direction of a particle over its lifetime',
        size_y: 'Define a curve to determine the size change in the Y-axis direction of a particle over its lifetime',
        size_z: 'Define a curve to determine the size change in the Z-axis direction of a particle over its lifetime',
        size_v: 'Define a curve to determine the size change of a particle over its lifetime',
        size_separate: 'Decide whether to control particle size independently on each axis',
        velocity_x: 'Velocity component in the X-axis direction',
        velocity_y: 'Velocity component in Y-axis direction',
        velocity_z: 'Velocity component in the Z-axis direction',
        velocity_speed: 'Velocity correction factor (CPU particles only supported)',
        velocity_space: 'The coordinate system used for velocity calculation',
        texture_mode: 'Set the type of particle mapping animation (Grid mode only)',
        texture_x: 'X-direction animation frame count',
        texture_y: 'Y-directional animation frame count',
        texture_animation: 'How the animation plays',
        texture_frame: 'Frame time curve of animation playback in one cycle',
        texture_start_frame: 'Play from the first few frames, time for the entire life cycle of the particle system',
        texture_cycle: 'The number of times a cycle is played in a lifetime',
        texture_random: 'Randomly select a line from the animated texture to generate an animation. \This option only works when the animation is played in SingleRow',
        texture_row: 'Select a specific line from the animated texture to generate an animation. \n This option is only available when the animation is played as SingleRow and randomRow is disabled',
    },
    editbox: {
