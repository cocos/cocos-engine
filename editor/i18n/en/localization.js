...
module.exports = {
    ...
    particle_system: {
        ...
        renderCulling: 'Render culling option, if switch enable the emitter will generate a bounding box and if main camera can not see the bounding box the emitter will be culled. The culled behavior will be described in cullingMode.',
