...
module.exports = {
    help: {
        cc: {
            ...
            ConeCollider: `${url}/${version}/manual/en/physics/physics-component.html`,
            ...
            PlaneCollider: `${url}/${version}/manual/en/physics/physics-component.html`,
            SphereCollider: `${url}/${version}/manual/en/physics/physics-component.html`,
            SimplexCollider: `${url}/${version}/manual/en/physics/physics-component.html`,
            TerrainCollider: `${url}/${version}/manual/en/physics/physics-component.html`,
    ...
    physics3d: {
        ...
        constraint: {
            ...
            connectedBody: 'The rigid body connected to the constraint, <br>if not set, it will be connected to the world',
            ...
            linearLimit: {
                ...
                damping: 'The damping of the constraint',
                restitution: 'The restitution of the constraint',
            },
            angularLimit: {
                ...
                swingStiffness: 'The stiffness of the swing constraint',
                swingDamping: 'The damping of the swing constraint',
                swingRestitution: 'The restitution of the swing constraint',
                enableSoftConstraintTwist: 'Whether to enable soft constraint for the twist constraint',
                twistStiffness: 'The stiffness of the twist constraint',
                twistDamping: 'The damping of the twist constraint',
                twistRestitution: 'The restitution of the twist constraint',
            },
            linearDriver: {
