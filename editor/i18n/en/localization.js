...
module.exports = {
    ...
    skybox: {
        applyDiffuseMap: 'When checking, <br>scene objects will use accurate diffusion map instead of hemisphere lighting.',
        enabled: 'Enable or disable skybox rendering with Envmap cube texture settings.',
        useIBL: 'When checking, <br>scene objects will calculate image based lighting from Envmap settings with diffuse and specular-reflections. <br>Otherwise objects only calculate hemisphere diffuse lighting.',
        useHDR: 'Toggle HDR or LDR mode. <br>Each mode has seperate light source settings, HDR mode uses physical luminosity unit with camera exposure attributes, <br>and LDR mode uses none-unit without exposure calculations.',
    ...
    shadow: {
        ...
        saturation: 'Shadow saturation. <br>This value should be 1.0, we recommend that you\'d rather increase ambient lighting than modify this value. ',
        pcf: 'Enable soft shadows.',
        bias: 'Bias value (world space unit) that can avoid moire artifacts with shadows. <br>The more the value, the more the light leakage.',
        normalBias: 'Bias value (world space unit) that can avoid moire artifacts with surfaces <br>that parallel to the directional light.',
        shadowMapSize: 'Shadowmap resolutions.',
        fixedArea: 'Toggle CSM and fixed area shadows. <br>When checking, shadow will not follow camera, <br>it distributes around directional light position. <br>It is a legacy mode that we do not recommend.',
        near: 'Fix area start.',
        far: 'Fix area end.',
        orthoSize: 'Fix area size, the larger value, <br>the lower precision of shadows.',
        invisibleOcclusionRange: 'If some shadow near the camera is missing, <br>increase this value (world space unit) to fix it.',
