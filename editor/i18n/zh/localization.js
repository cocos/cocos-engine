module.exports = {
    ...
    help: {
        cc: {
            ModelComponent: 'https://docs.cocos.com/creator3d/manual/zh/engine/renderable/model-component.html',
            UITransformComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/ui-transform.html',
            SpriteComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/sprite.html',
            ...
            CameraComponent: 'https://docs.cocos.com/creator3d/manual/zh/editor/components/camera-component.html',
            CanvasComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/canvas.html',
            SkinningModelComponent: 'https://docs.cocos.com/creator3d/manual/zh/engine/animation/skeletal-animation.html',
            BatchedSkinningModel: 'https://docs.cocos.com/creator3d/manual/zh/engine/animation/skeletal-animation.html',
            DirectionalLightComponent: 'https://docs.cocos.com/creator3d/manual/zh/concepts/scene/light/dir-light.html',
            SphereLightComponent: 'https://docs.cocos.com/creator3d/manual/zh/concepts/scene/light/sphere-light.html',
            SpotLightComponent: 'https://docs.cocos.com/creator3d/manual/zh/concepts/scene/light/spot-light.html',
            UICoordinateTrackerComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/ui-coordinate-tracker.html',
            AnimationComponent: 'https://docs.cocos.com/creator3d/manual/zh/engine/animation/animation-component.html',
            SkeletalAnimationComponent: 'https://docs.cocos.com/creator3d/manual/zh/engine/animation/skeletal-animation.html',
            AudioSourceComponent: 'https://docs.cocos.com/creator3d/manual/zh/audio-system/overview.html',
            BillboardComponent: 'https://docs.cocos.com/creator3d/manual/zh/particle-system/billboard-component.html',
            LineComponent: 'https://docs.cocos.com/creator3d/manual/zh/particle-system/line-component.html',
            ParticleSystemComponent: 'https://docs.cocos.com/creator3d/manual/zh/particle-system/main-module.html',
            ButtonComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/button.html',
            LabelComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/label.html',
            EditBoxComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/editbox.html',
            LayoutComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/layout.html',
            GraphicsComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/graphics.html',
            MaskComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/mask.html',
            ProgressBarComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/progress.html',
            LabelOutlineComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/label-outline.html',
            RichTextComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/richtext.html',
            ScrollBarComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/scrollbar.html',
            ScrollView: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/scrollview.html',
            SliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/slider.html',
            ...
            PageViewComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/pageview.html',
            UIStaticBatchComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/ui-static.html',
            UIOpacityComponent: 'https://docs.cocos.com/creator3d/manual/zh/ui-system/components/editor/ui-opacity.html',
            BoxColliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-collider.html',
            SphereColliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-component.html',
            CapsuleColliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-component.html',
            CylinderColliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-component.html',
            MeshColliderComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-component.html',
            RigidBodyComponent: 'https://docs.cocos.com/creator3d/manual/zh/physics/physics-rigidbody.html',
    ...
    particle: {
        ...
        start_color: '粒子初始颜色',
        scale_space: '选择缩放坐标系',
        start_size_3d: '是否开启粒子分别在 XYZ 轴的初始大小',
        start_size: '粒子初始大小',
        start_speed: '粒子初始速度',
        start_rotation_3d: '是否开启粒子分别在 XYZ 轴的旋转角度',
        start_rotation: '粒子初始旋转角度',
        start_delay: '粒子系统开始运行后，延迟粒子发射的时间',
        start_life_time: '粒子生命周期',
        duration: '粒子系统运行时间',
        loop: '粒子系统是否循环播放',
        prewarm: '选中之后，粒子系统会以已播放完一轮之后的状态开始播放（仅当循环播放启用时有效）',
        simulation_space: '控制粒子坐标计算所在的坐标系',
        simulation_speed: '控制整个粒子系统的更新速度',
        play_on_awake: '粒子系统加载后是否自动开始播放',
        gravity_modifier: '粒子受重力影响的重力系数',
        rate_over_time: '每秒发射的粒子数',
        rate_over_distance: '每移动单位距离发射的粒子数',
        ...
        force_module: '加速度模块',
        limit_module: '限速模块',
        rotation_module: '旋转模块',
        texture_module: '贴图动画模块',
        trail_module: '拖尾模块',
        renderer_module: '渲染模块',
        culling: '是否剔除非 enable 的模块数据',
        billboard_texture: 'billboard显示的贴图',
        billboard_height: 'billboard的高度',
        billboard_width: 'billboard的宽度',
        billboard_rotation: 'billboard绕中心点旋转的角度',
        render_mode: '设定粒子生成模式',
        velocity_scale: '在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按速度大小进行拉伸',
        length_scale: '在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按粒子大小进行拉伸',
        mesh: '粒子发射的模型',
        particle_material: '粒子使用的材质',
        trail_material: '拖尾使用的材质',
        use_gpu: '是否启用GPU粒子（材质的 effect 需要选择 builtin-particle-gpu）',
        line_texture: '线段中显示的贴图',
        line_space: '线段中各个点的坐标采用哪个坐标系，勾选使用世界坐标系，不选使用本地坐标系',
        line_positions: '每个线段端点的坐标',
        line_width: '线段宽度，如果采用曲线，则表示沿着线段方向上的曲线变化',
        line_tile: '贴图平铺次数',
        line_offset: '贴图坐标的偏移',
        line_color: '线段颜色，如果采用渐变色，则表示沿着线段方向上的颜色渐变',
        trail_mode: 'Particle在每个粒子的运动轨迹上形成拖尾效果',
        trail_life: '拖尾的生命周期',
        trail_distance: '粒子每生成一个拖尾节点所运行的最短距离',
        trail_space: '拖尾所在的坐标系，World在世界坐标系中运行，Local在本地坐标系中运行',
        trail_exist: '拖尾是否跟随粒子一起消失',
        trail_texture: '贴图在拖尾上的展开形式，Stretch贴图覆盖在整条拖尾上，Repeat贴图覆盖在一段拖尾上',
        trail_width: '拖尾宽度继承自粒子大小',
        trail_ratio: '拖尾宽度，如果继承自粒子则是粒子大小的比例',
        trail_color: '拖尾颜色是否继承自粒子',
        trail_gradient: '拖尾颜色随拖尾自身长度的颜色渐变',
        trail_time_gradient: '拖尾颜色随时间的颜色渐变',
        shape_position: '粒子发射器位置',
        shape_rotation: '粒子发射器旋转角度',
        shape_scale: '粒子发射器缩放比例',
        shape_arc: '粒子发射器在一个扇形范围内发射',
        shape_angle: '圆锥的轴与母线的夹角\n决定圆锥发射器的开合程度',
        shape_type: '粒子发射器类型',
        shape_emit: '粒子从发射器哪个部位发射',
        shape_dir: '根据粒子的初始方向决定粒子的移动方向',
        shape_random: '粒子生成方向随机设定',
        shape_spherical: '表示当前发射方向与当前位置到结点中心连线方向的插值',
        shape_amount: '粒子生成位置随机设定（设定此值为非 0 会使粒子生成位置超出生成器大小范围）',
        shape_radius: '粒子发射器半径',
        shape_thickness: '半径厚度',
        shape_arc_mode: '粒子在扇形范围内的发射方式',
        shape_arc_spread: '控制可能产生粒子的弧周围的离散间隔',
        shape_arc_speed: '粒子沿圆周发射的速度',
        shape_length: '圆锥顶部截面距离底部的轴长\n决定圆锥发射器的高度',
        shape_box: '粒子发射器发射位置（针对 Box 类型的粒子发射器）',
        force_x: 'X 轴方向上的加速度分量',
        force_y: 'Y 轴方向上的加速度分量',
        force_z: 'Z 轴方向上的加速度分量',
        force_space: '加速度计算时采用的坐标',
        limit_x: 'X 轴方向上的速度下限',
        limit_y: 'Y 轴方向上的速度下限',
        limit_z: 'Z 轴方向上的速度下限',
        limit_v: '速度下限',
        limit_dampen: '当前速度与速度下限的插值',
        limit_separate: '是否三个轴分开限制',
        limit_space: '计算速度下限时采用的坐标系',
        rotation_x: '绕 X 轴设定旋转',
        rotation_y: '绕 Y 轴设定旋转',
        rotation_z: '绕 Z 轴设定旋转',
        rotation_separate: '是否三个轴分开设定旋转（暂不支持)',
        size_x: '定义一条曲线来决定粒子在其生命周期中 X 轴方向上的大小变化',
        size_y: '定义一条曲线来决定粒子在其生命周期中 Y 轴方向上的大小变化',
        size_z: '定义一条曲线来决定粒子在其生命周期中 Z 轴方向上的大小变化',
        size_v: '定义一条曲线来决定粒子在其生命周期中的大小变化',
        size_separate: '决定是否在每个轴上独立控制粒子大小',
        velocity_x: 'X 轴方向上的速度分量',
        velocity_y: 'Y 轴方向上的速度分量',
        velocity_z: 'Z 轴方向上的速度分量',
        velocity_speed: '速度修正系数（只支持 CPU 粒子）',
        velocity_space: '速度计算时采用的坐标系',
        texture_mode: '设定粒子贴图动画的类型（暂只支持 Grid 模式）',
        texture_x: 'X 方向动画帧数',
        texture_y: 'Y 方向动画帧数',
        texture_animation: '动画播放方式',
        texture_frame: '一个周期内动画播放的帧与时间变化曲线',
        texture_start_frame: '从第几帧开始播放，时间为整个粒子系统的生命周期',
        texture_cycle: '一个生命周期内播放循环的次数',
        texture_random: '随机从动画贴图中选择一行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时生效',
        texture_row: '从动画贴图中选择特定行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时且禁用 randomRow 时可用',
    },
    editbox: {
