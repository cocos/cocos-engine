...
module.exports = {
    help: {
        cc: {
            ...
            ConeCollider: `${url}/${version}/manual/zh/physics/physics-component.html`,
            ...
            PlaneCollider: `${url}/${version}/manual/zh/physics/physics-component.html`,
            SphereCollider: `${url}/${version}/manual/zh/physics/physics-component.html`,
            SimplexCollider: `${url}/${version}/manual/zh/physics/physics-component.html`,
            TerrainCollider: `${url}/${version}/manual/zh/physics/physics-component.html`,
    ...
    physics3d: {
        ...
        constraint: {
            ...
            connectedBody: '约束连接的刚体， 未设置时为世界坐标系',
            ...
            angularLimit: {
                ...
                swingStiffness: '摆动约束的刚度',
                swingDamping: '摆动约束的阻尼',
                swingRestitution: '摆动约束的恢复',
                enableSoftConstraintTwist: '是否启用扭转角度的软约束',
                twistStiffness: '扭转约束的刚度',
                twistDamping: '扭转约束的阻尼',
                twistRestitution: '扭转约束的恢复',
            },
            linearDriver: {
                xMode: '沿x轴的驱动器模式',
                yMode: '沿y轴的驱动器模式',
