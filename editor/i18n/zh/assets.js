module.exports = {
    assets: {
        ...
        spriteFrame: {
            ...
            rotated: 'Rotated',
            rotatedTip: '图集中的子资源是否被旋转',
            offsetX: 'Offset X',
            offsetXTip: '图集中图片矩形的X轴偏移量',
            offsetY: 'Offset Y',
            offsetYTip: '图集中图片矩形的Y轴偏移量',
            trimType: 'Trim Type',
            trimTypeTip: '裁剪类型',
            trimThreshold: 'Trim Threshold',
            trimThresholdTip: '裁剪的透明度阈值',
            trimX: 'Trim X',
            trimXTip: '裁剪矩形左上角的x坐标',
            trimY: 'Trim Y',
            trimYTip: '裁剪矩形左上角的y坐标',
            width: 'Trim Width',
            widthTip: '裁剪矩形宽度',
            height: 'Trim Height',
            heightTip: '裁剪矩形高度',
        ...
        texture: {
            ...
            magfilterTip: '放大过滤算法',
            mipfilter: 'Mip Filter',
            mipfilterTip: '多级纹理过滤算法',
            wrapModeS: 'Wrap Mode S',
            wrapModeSTip: 'S(U)方向纹理寻址模式',
            wrapModeT: 'Wrap Mode T',
            wrapModeTTip: 'T(V)方向纹理寻址模式',
            modeWarn:
