module.exports = {
    ...
    assets: {
        ...
        javascript: {
            ...
            loadPluginInWebTip: '勾选时，在 Web 运行环境包含构建后和浏览器预览才会加载/包含此脚本',
            ...
            loadPluginInMiniGame: '小游戏平台构建包内是否需要包含此脚本',
            globalThisAliasTip: '填写后，Creator 将封装必要的代码以增加此名称的全局变量，以便以全局变量方式提供的第三方库可以更好的跨平台使用',
        },
        scene: {
