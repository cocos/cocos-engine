...
se::Object* __jsb_anysdk_framework_ProtocolYAP_proto = nullptr;
se::Class* __jsb_anysdk_framework_ProtocolYAP_class = nullptr;

static bool js_anysdk_framework_ProtocolYAP_getOrderId(se::State& s)
{
    anysdk::framework::ProtocolYAP* cobj = (anysdk::framework::ProtocolYAP*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_anysdk_framework_ProtocolYAP_getOrderId : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= std_string_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_anysdk_framework_ProtocolYAP_getOrderId : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_anysdk_framework_ProtocolYAP_getOrderId)

static bool js_anysdk_framework_ProtocolYAP_getPluginId(se::State& s)
{
    anysdk::framework::ProtocolYAP* cobj = (anysdk::framework::ProtocolYAP*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_anysdk_framework_ProtocolYAP_getPluginId : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= std_string_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_anysdk_framework_ProtocolYAP_getPluginId : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_anysdk_framework_ProtocolYAP_getPluginId)

static bool js_anysdk_framework_ProtocolYAP_resetYapState(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_anysdk_framework_ProtocolYAP_resetYapState)
...
{
    auto cls = se::Class::create("ProtocolYAP", obj, __jsb_anysdk_framework_PluginProtocol_proto, nullptr);

    cls->defineFunction("getOrderId", _SE(js_anysdk_framework_ProtocolYAP_getOrderId));
    cls->defineFunction("getPluginId", _SE(js_anysdk_framework_ProtocolYAP_getPluginId));
    cls->defineStaticFunction("resetYapState", _SE(js_anysdk_framework_ProtocolYAP_resetYapState));
    cls->install();
    JSBClassType::registerClass<anysdk::framework::ProtocolYAP>(cls);

    __jsb_anysdk_framework_ProtocolYAP_proto = cls->getProto();
    __jsb_anysdk_framework_ProtocolYAP_class = cls;
...
static bool js_anysdk_framework_ProtocolAdTracking_onYap(se::State& s)
{
    anysdk::framework::ProtocolAdTracking* cobj = (anysdk::framework::ProtocolAdTracking*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_anysdk_framework_ProtocolAdTracking_onYap : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::map<std::string, std::string> arg0;
        ok &= seval_to_std_map_string_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_anysdk_framework_ProtocolAdTracking_onYap : Error processing arguments");
        cobj->onYap(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_anysdk_framework_ProtocolAdTracking_onYap)
...
bool js_register_anysdk_framework_ProtocolAdTracking(se::Object* obj)
{
    ...
    cls->defineFunction("onYap", _SE(js_anysdk_framework_ProtocolAdTracking_onYap));
...
bool register_all_anysdk_framework(se::Object* obj)
{
    ...
    js_register_anysdk_framework_ProtocolYAP(ns);
