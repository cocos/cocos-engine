...
const subDir = path.relative(path.join(COCOS_NATIVE_ROOT, '..'), WORK_DIR);
if (process.argv.length === 2 && !subDir.startsWith('..')) {
    console.log(`The engine's binding code is now automatically generated by CMake, eliminating the need to run the script manually.
