...
%attribute(cc::scene::Pass, bool, rootBufferDirty, isRootBufferDirty, setRootBufferDirty);
%attribute(cc::scene::Pass, cc::pipeline::RenderPriority, priority, getPriority, setPriority);
