...
def main():
    ...
    creator_root = os.path.abspath(os.path.join(project_root, 'frameworks/runtime-src/Classes'))
    ...
    try:
        ...
        output_dir = '%s/frameworks/runtime-src/Classes/jsb' % project_root

        cmd_args = {'creator.ini': ('creator', 'jsb_creator_auto'),
                    }
        target = 'spidermonkey'
