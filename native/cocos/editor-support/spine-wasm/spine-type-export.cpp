...
EMSCRIPTEN_BINDINGS(spine) {
    ...
    class_<Event>("Event")
        ...
        .function("getData", optional_override([](Event &obj) { return &obj.getData(); }), allow_raw_pointers())
    ...
    class_<VertexAttachment, base<Attachment>>("VertexAttachment")
        ...
        .function("getBones", optional_override([](VertexAttachment &obj) { return VECTOR_SP2STD(obj.getBones()); }), allow_raw_pointers())
