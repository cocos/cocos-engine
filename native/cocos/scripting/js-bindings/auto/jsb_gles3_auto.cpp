...
#endif
se::Object* __jsb_cc_GLES3Device_proto = nullptr;
se::Class* __jsb_cc_GLES3Device_class = nullptr;
...
SE_DECLARE_FINALIZE_FUNC(js_cc_GLES3Device_finalize)

static bool js_gles3_GLES3Device_constructor(se::State& s)
{
    cc::GLES3Device* cobj = JSB_ALLOC(cc::GLES3Device);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
SE_BIND_CTOR(js_gles3_GLES3Device_constructor, __jsb_cc_GLES3Device_class, js_cc_GLES3Device_finalize)



extern se::Object* __jsb_cc_GFXDevice_proto;

static bool js_cc_GLES3Device_finalize(se::State& s)
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cc::GLES3Device)", s.nativeThisObject());
...
SE_BIND_FINALIZE_FUNC(js_cc_GLES3Device_finalize)

bool js_register_gles3_GLES3Device(se::Object* obj)
{
    auto cls = se::Class::create("GLES3Device", obj, __jsb_cc_GFXDevice_proto, _SE(js_gles3_GLES3Device_constructor));
    ...
    cls->defineFinalizeFunction(_SE(js_cc_GLES3Device_finalize));
    cls->install();
    JSBClassType::registerClass<cc::GLES3Device>(cls);

    __jsb_cc_GLES3Device_proto = cls->getProto();
    __jsb_cc_GLES3Device_class = cls;
