...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_normalizePath);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getFileDir);
...
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_setTransform);
...
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_scale);
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_clearRect);
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_transform);
...
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_fillRect);
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_rotate);
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_beginPath);
SE_DECLARE_FUNC(js_cocos2dx_CanvasRenderingContext2D_translate);
