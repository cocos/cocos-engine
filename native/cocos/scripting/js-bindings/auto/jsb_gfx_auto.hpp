...
SE_DECLARE_FUNC(js_gfx_GFXDevice_renderer);
SE_DECLARE_FUNC(js_gfx_GFXDevice_createCommandAllocator);
SE_DECLARE_FUNC(js_gfx_GFXDevice_nativeWidth);
SE_DECLARE_FUNC(js_gfx_GFXDevice_commandAllocator);
SE_DECLARE_FUNC(js_gfx_GFXDevice_createPipelineState);
SE_DECLARE_FUNC(js_gfx_GFXDevice_vendor);
...
SE_DECLARE_FUNC(js_gfx_GFXDevice_memoryStatus);
SE_DECLARE_FUNC(js_gfx_GFXDevice_createWindow);
SE_DECLARE_FUNC(js_gfx_GFXDevice_numDrawCalls);
...
SE_DECLARE_FUNC(js_gfx_GFXDevice_nativeHeight);
SE_DECLARE_FUNC(js_gfx_GFXDevice_createQueue);
SE_DECLARE_FUNC(js_gfx_GFXDevice_numTris);
SE_DECLARE_FUNC(js_gfx_GFXDevice_queue);
SE_DECLARE_FUNC(js_gfx_GFXDevice_context);
SE_DECLARE_FUNC(js_gfx_GFXDevice_mainWindow);
...
bool register_all_gfx(se::Object* obj);
SE_DECLARE_FUNC(js_gfx_GFXSampler_maxLOD);
SE_DECLARE_FUNC(js_gfx_GFXSampler_mipLODBias);
SE_DECLARE_FUNC(js_gfx_GFXSampler_initialize);
SE_DECLARE_FUNC(js_gfx_GFXSampler_destroy);
SE_DECLARE_FUNC(js_gfx_GFXSampler_minLOD);
...
SE_DECLARE_FUNC(js_gfx_GLES2Device_useInstancedArrays);
