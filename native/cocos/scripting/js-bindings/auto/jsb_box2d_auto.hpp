...
bool js_box2dclasses_b2Draw_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2Shape_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2CircleShape_b2CircleShape(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2EdgeShape_b2EdgeShape(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2ChainShape_b2ChainShape(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2Body_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2Fixture_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2ContactListener_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2QueryCallback_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2RayCastCallback_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2World_b2World(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *jsb_b2Contact_class;
extern JSObject *jsb_b2Contact_prototype;

bool js_box2dclasses_b2Contact_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2Joint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2DistanceJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2FrictionJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2GearJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2MotorJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2MouseJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2PrismaticJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2PulleyJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2RevoluteJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2RopeJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2WeldJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_box2dclasses_b2WheelJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp);
