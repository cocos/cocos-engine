...
#endif
se::Object* __jsb_cc_GLES2Device_proto = nullptr;
se::Class* __jsb_cc_GLES2Device_class = nullptr;
...
SE_DECLARE_FINALIZE_FUNC(js_cc_GLES2Device_finalize)

static bool js_gles2_GLES2Device_constructor(se::State& s)
{
    cc::GLES2Device* cobj = JSB_ALLOC(cc::GLES2Device);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
SE_BIND_CTOR(js_gles2_GLES2Device_constructor, __jsb_cc_GLES2Device_class, js_cc_GLES2Device_finalize)



extern se::Object* __jsb_cc_GFXDevice_proto;

static bool js_cc_GLES2Device_finalize(se::State& s)
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cc::GLES2Device)", s.nativeThisObject());
...
SE_BIND_FINALIZE_FUNC(js_cc_GLES2Device_finalize)

bool js_register_gles2_GLES2Device(se::Object* obj)
{
    auto cls = se::Class::create("GLES2Device", obj, __jsb_cc_GFXDevice_proto, _SE(js_gles2_GLES2Device_constructor));
    ...
    cls->defineFinalizeFunction(_SE(js_cc_GLES2Device_finalize));
    cls->install();
    JSBClassType::registerClass<cc::GLES2Device>(cls);

    __jsb_cc_GLES2Device_proto = cls->getProto();
    __jsb_cc_GLES2Device_class = cls;
