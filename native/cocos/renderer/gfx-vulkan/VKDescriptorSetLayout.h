#ifndef CC_GFXVULKAN_CCVK_DESCRIPTOR_SET_LAYOUT_H_
#define CC_GFXVULKAN_CCVK_DESCRIPTOR_SET_LAYOUT_H_
...
class CC_VULKAN_API CCVKDescriptorSetLayout : public DescriptorSetLayout {
public:
...
#endif // CC_GFXVULKAN_CCVK_DESCRIPTOR_SET_LAYOUT_H_
