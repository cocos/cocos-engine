...
// objects recycled before acquire should be put into last frame's bin
...
CCVKGPUTransportHub *CCVKDevice::gpuTransportHub() { return _gpuTransportHubs[_gpuDevice->curBackBufferIndex]; }
