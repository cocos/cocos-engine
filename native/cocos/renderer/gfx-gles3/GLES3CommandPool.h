#ifndef CC_GFXGLES3_GLES3_COMMAND_POOL_H_
#define CC_GFXGLES3_GLES3_COMMAND_POOL_H_

#include "GLES3Commands.h"

NS_CC_BEGIN

template <typename T, typename = std::enable_if<std::is_base_of<GLES3Cmd, T>::value>>
class GLES3CommandPool {
 public:
  GLES3CommandPool(): free_cmds_(1) {
    frees_ = new T*[1];
    count_ = 1;
    free_idx_ = 0;
