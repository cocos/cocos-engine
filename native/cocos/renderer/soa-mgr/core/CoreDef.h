#ifndef __COREDEF_H__
#define __COREDEF_H__

// CC Engine version
#define CC_CORE_VER 1.0
...
// Precision
#define CC_PREC_FLOAT         1
#define CC_PREC_DOUBLE        2
...
# warning mac applecc os
#else
# warning no mac applecc
#endif

#if defined(__APPLE__)
# warning mac apple os
#else
# warning no mac apple
#endif
...
// Endian Settings
//static union { char c[4]; unsigned long nVar; } _CCEndian = {{ 'L', '?', '?', 'B' } };
//static const int _CCEndianFlag = ((char)_CCEndian.nVar == 'L'? CC_ENDIAN_LITTLE : CC_ENDIAN_BIG);
//#define CC_ENDIAN     _CCEndianFlag
...
//#	warning "cc debug mode"
#else
#	define CC_MODE        CC_MODE_RELEASE
//#	warning	"CC release mode"
#endif

#if defined(CC_EDITOR)
#	define CC_VERBOSE_LOG
#endif

// CC Engine Memory Managed
#if (CC_PLATFORM == CC_PLATFORM_WINDOWS)
...
// CC STL memory allocator
#if (CC_MEMORY_ALLOCATOR == CC_MEMORY_ALLOCATOR_STD && !defined(CC_USE_EASTL))
...
#define USING_CC_NAMESPACE	using namespace CC;
