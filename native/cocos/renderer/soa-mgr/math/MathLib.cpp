...
const float PI_DIV180				= Math::PI / 180.0f;
...
const float EPSILON					= KSTD::numeric_limits<float>::epsilon();
const float LOWEPSILON				= (float)(1e-04);
const float POS_INFINITY			= KSTD::numeric_limits<float>::infinity();
const float NEG_INFINITY			= -KSTD::numeric_limits<float>::infinity();
...
const float EPSILONQUAT				= 0.0001f;
...
const Dword MAX_DWORD				= 0xffffffff;
const i8 MIN_I8						= -128;
const i8 MAX_I8						= 127;
const ui8 MIN_UI8 = 0;
...
inline void CRCUpdateB(ui32& crc, ui8 b)
{
