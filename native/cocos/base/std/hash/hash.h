...
template <>
struct basic_numbers<bool> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<char> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<unsigned char> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<signed char> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<short> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<unsigned short> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<int> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<unsigned int> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<long> : ccstd::hash_detail::enable_hash_value {};
template <>
struct basic_numbers<unsigned long> : ccstd::hash_detail::enable_hash_value {};

    #if !defined(BOOST_NO_INTRINSIC_WCHAR_T)
template <>
struct basic_numbers<wchar_t> : ccstd::hash_detail::enable_hash_value {};
    #endif

    #if !defined(BOOST_NO_CXX11_CHAR16_T)
template <>
struct basic_numbers<char16_t> : ccstd::hash_detail::enable_hash_value {};
    #endif

    #if !defined(BOOST_NO_CXX11_CHAR32_T)
template <>
struct basic_numbers<char32_t> : ccstd::hash_detail::enable_hash_value {};
    #endif
...
template <typename T>
struct long_numbers : long_numbers2<T> {};
template <typename T>
struct ulong_numbers : ulong_numbers2<T> {};

    #if !defined(BOOST_NO_LONG_LONG)
template <>
struct long_numbers<boost::long_long_type> : ccstd::hash_detail::enable_hash_value {};
template <>
struct ulong_numbers<boost::ulong_long_type> : ccstd::hash_detail::enable_hash_value {};
    #endif

    #if defined(BOOST_HAS_INT128)
template <>
struct long_numbers2<boost::int128_type> : ccstd::hash_detail::enable_hash_value {};
template <>
struct ulong_numbers2<boost::uint128_type> : ccstd::hash_detail::enable_hash_value {};
    #endif

template <>
struct float_numbers<float> : ccstd::hash_detail::enable_hash_value {};
template <>
struct float_numbers<double> : ccstd::hash_detail::enable_hash_value {};
template <>
struct float_numbers<long double> : ccstd::hash_detail::enable_hash_value {};
} // namespace hash_detail
...
inline hash_t hash_value_signed(T val) {
    ...
    const int length = (std::numeric_limits<T>::digits - 1) / static_cast<int>(size_t_bits);
...
// Implementation by Alberto Barbati and Dave Harris.
    #if !BOOST_WORKAROUND(__DMC__, <= 0x848)
template <class T>
hash_t hash_value(T* const& v)
    #else
template <class T>
hash_t hash_value(T* v)
    #endif
{
...
template <class T>
struct hash
: public ccstd::hash_detail::hash_impl<ccstd::is_pointer<T>::value>::BOOST_NESTED_TEMPLATE inner<T> {
};
...
#if !defined(CCSTD_HASH_NO_EXTENSIONS) && !defined(CCSTD_FUNCTIONAL_HASH_EXTENSIONS_HPP)
