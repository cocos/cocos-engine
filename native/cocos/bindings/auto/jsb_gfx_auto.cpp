...
static bool js_gfx_TextureCopy_set_srcSubres(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    cc::gfx::TextureSubres arg0;
    ok &= seval_to_gfx_texture_subres(args[0], &arg0);
...
static bool js_gfx_TextureCopy_set_srcOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    cc::gfx::Offset arg0;
    ok &= seval_to_gfx_offset(args[0], &arg0);
...
static bool js_gfx_TextureCopy_set_extent(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    cc::gfx::Extent arg0;
    ok &= seval_to_gfx_extent(args[0], &arg0);
...
static bool js_gfx_TextureCopy_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_texture_subres(field, &arg0);
            cobj->srcSubres = arg0;
        }
        cc::gfx::Offset arg1;
        json->getProperty("srcOffset", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_offset(field, &arg1);
            cobj->srcOffset = arg1;
        }
        cc::gfx::TextureSubres arg2;
        json->getProperty("dstSubres", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_texture_subres(field, &arg2);
            cobj->dstSubres = arg2;
        }
        cc::gfx::Offset arg3;
        json->getProperty("dstOffset", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_offset(field, &arg3);
            cobj->dstOffset = arg3;
        }
        cc::gfx::Extent arg4;
        json->getProperty("extent", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_extent(field, &arg4);
            cobj->extent = arg4;
        }
    ...
    else
    {
        ...
        if (argc > 1 && !args[1].isUndefined()) {
            cc::gfx::Offset arg1;
            ok &= seval_to_gfx_offset(args[1], &arg1);
            cobj->srcOffset = arg1;
        }
        if (argc > 2 && !args[2].isUndefined()) {
            cc::gfx::TextureSubres arg2;
            ok &= seval_to_gfx_texture_subres(args[2], &arg2);
            cobj->dstSubres = arg2;
        }
        if (argc > 3 && !args[3].isUndefined()) {
            cc::gfx::Offset arg3;
            ok &= seval_to_gfx_offset(args[3], &arg3);
            cobj->dstOffset = arg3;
        }
        if (argc > 4 && !args[4].isUndefined()) {
            cc::gfx::Extent arg4;
            ok &= seval_to_gfx_extent(args[4], &arg4);
            cobj->extent = arg4;
        }
...
static bool js_gfx_BufferTextureCopy_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_offset(field, &arg2);
            cobj->texOffset = arg2;
        }
        cc::gfx::Extent arg3;
        json->getProperty("texExtent", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_extent(field, &arg3);
            cobj->texExtent = arg3;
        }
        cc::gfx::TextureSubres arg4;
        json->getProperty("texSubres", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_texture_subres(field, &arg4);
            cobj->texSubres = arg4;
        }
    ...
    else
    {
        ...
        if (argc > 2 && !args[2].isUndefined()) {
            cc::gfx::Offset arg2;
            ok &= seval_to_gfx_offset(args[2], &arg2);
            cobj->texOffset = arg2;
        }
        if (argc > 3 && !args[3].isUndefined()) {
            cc::gfx::Extent arg3;
            ok &= seval_to_gfx_extent(args[3], &arg3);
            cobj->texExtent = arg3;
        }
        if (argc > 4 && !args[4].isUndefined()) {
            cc::gfx::TextureSubres arg4;
            ok &= seval_to_gfx_texture_subres(args[4], &arg4);
            cobj->texSubres = arg4;
        }
...
static bool js_gfx_BindingMappingInfo_get_bufferOffsets(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= std_vector_int_to_seval(cobj->bufferOffsets, &jsret);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_BindingMappingInfo_get_samplerOffsets(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= std_vector_int_to_seval(cobj->samplerOffsets, &jsret);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_BindingMappingInfo_get_flexibleSet(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= uint32_to_seval((unsigned int)cobj->flexibleSet, &jsret);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_BindingMappingInfo_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        if(!field.isUndefined()) {
            ...
            cobj->samplerOffsets = arg1;
        }
        unsigned int arg2 = 0;
        json->getProperty("flexibleSet", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_uint32(field, (uint32_t*)&arg2);
            cobj->flexibleSet = arg2;
        }
...
static bool js_gfx_SamplerInfo_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        if(!field.isUndefined()) {
            ok &= seval_to_gfx_color(field, &arg8);
    ...
    else
    {
        ...
        if (argc > 8 && !args[8].isUndefined()) {
            cc::gfx::Color arg8;
            ok &= seval_to_gfx_color(args[8], &arg8);
            cobj->borderColor = arg8;
        }
...
static bool js_gfx_DescriptorSetLayoutBinding_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        cc::gfx::DescriptorType arg1;
        json->getProperty("descriptorType", &field);
        if(!field.isUndefined()) {
            do { int32_t tmp = 0; ok &= seval_to_int32(field, &tmp); arg1 = (cc::gfx::DescriptorType)tmp; } while(false);
            cobj->descriptorType = arg1;
        }
        unsigned int arg2 = 0;
        json->getProperty("count", &field);
        if(!field.isUndefined()) {
        ...
        cc::gfx::ShaderStageFlagBit arg3;
        json->getProperty("stageFlags", &field);
        if(!field.isUndefined()) {
            do { int32_t tmp = 0; ok &= seval_to_int32(field, &tmp); arg3 = (cc::gfx::ShaderStageFlagBit)tmp; } while(false);
            cobj->stageFlags = arg3;
        }
        std::vector<cc::gfx::Sampler *> arg4;
        json->getProperty("immutableSamplers", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_std_vector(field, &arg4);
            cobj->immutableSamplers = arg4;
        }
    ...
    else
    {
        ...
        if (argc > 1 && !args[1].isUndefined()) {
            cc::gfx::DescriptorType arg1;
            do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cc::gfx::DescriptorType)tmp; } while(false);
            cobj->descriptorType = arg1;
        }
        if (argc > 2 && !args[2].isUndefined()) {
            unsigned int arg2 = 0;
        ...
        if (argc > 3 && !args[3].isUndefined()) {
            cc::gfx::ShaderStageFlagBit arg3;
            do { int32_t tmp = 0; ok &= seval_to_int32(args[3], &tmp); arg3 = (cc::gfx::ShaderStageFlagBit)tmp; } while(false);
            cobj->stageFlags = arg3;
        }
        if (argc > 4 && !args[4].isUndefined()) {
            std::vector<cc::gfx::Sampler *> arg4;
