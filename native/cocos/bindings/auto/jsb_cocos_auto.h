...
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setFillStyle);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setFont);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setGlobalCompositeOperation);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setHeight);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setLineCap);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setLineJoin);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setLineWidth);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setStrokeStyle);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setTextAlign);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setTextBaseline);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setTransform);
SE_DECLARE_FUNC(js_engine_CanvasRenderingContext2D_setWidth);
