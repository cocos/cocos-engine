...
SE_DECLARE_FUNC(js_scene_Pass_setSampler);
SE_DECLARE_FUNC(js_scene_Pass_setSamplerArray);
SE_DECLARE_FUNC(js_scene_Pass_setTexture);
SE_DECLARE_FUNC(js_scene_Pass_setTextureAndSampler);
SE_DECLARE_FUNC(js_scene_Pass_setTextureAndSamplerArray);
SE_DECLARE_FUNC(js_scene_Pass_setTextureArray);
