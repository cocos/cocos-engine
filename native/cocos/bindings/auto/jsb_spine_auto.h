...
SE_DECLARE_FUNC(js_spine_SkeletonRenderer_setMaterial);
SE_DECLARE_FUNC(js_spine_SkeletonRenderer_setOpacityModifyRGB);
SE_DECLARE_FUNC(js_spine_SkeletonRenderer_setRenderEntity);
...
SE_DECLARE_FUNC(js_spine_SkeletonCacheAnimation_setMaterial);
SE_DECLARE_FUNC(js_spine_SkeletonCacheAnimation_setOpacityModifyRGB);
SE_DECLARE_FUNC(js_spine_SkeletonCacheAnimation_setRenderEntity);
