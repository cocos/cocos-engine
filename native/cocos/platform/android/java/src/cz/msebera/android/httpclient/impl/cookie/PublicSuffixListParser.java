 ...
 *
 * @deprecated (4.4) use {@link cz.msebera.android.httpclient.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
@Immutable
...
public class PublicSuffixListParser {
    ...
    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new cz.msebera.android.httpclient.conn.util.PublicSuffixListParser();
    }
