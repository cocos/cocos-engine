 ...
 *  <li>{@link cz.msebera.android.httpclient.conn.params.ConnConnectionPNames#MAX_STATUS_LINE_GARBAGE}</li>
 * </ul>
 *
 * @since 4.0
 *
...
public class DefaultResponseParser extends AbstractMessageParser<HttpMessage> {
    ...
    protected int getMaxGarbageLines(final HttpParams params) {
        return params.getIntParameter(
                cz.msebera.android.httpclient.conn.params.ConnConnectionPNames.MAX_STATUS_LINE_GARBAGE,
                Integer.MAX_VALUE);
    }
