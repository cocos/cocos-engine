...
public class VersionInfo {
     ...
     *                  for example "cz.msebera.android.httpclient".
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // cz.msebera.android.httpclient      becomes
     ...
     * @param pkg
     *            the package for which to load version information, for example "cz.msebera.android.httpclient". The package name
