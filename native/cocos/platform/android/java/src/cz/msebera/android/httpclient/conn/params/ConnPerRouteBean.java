 ...
 * {@link cz.msebera.android.httpclient.conn.ClientConnectionManager connection managers} for
 * a fine-grained control of connections on a per route basis.
 *
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link cz.msebera.android.httpclient.pool.ConnPoolControl}
 */
@Deprecated
@ThreadSafe
