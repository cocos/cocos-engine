...
public class RequestConfig implements Cloneable {
     ...
     *   cz.msebera.android.httpclient.impl.conn.PoolingHttpClientConnectionManager#getValidateAfterInactivity()}
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated (4.4) Use {@link
         *   cz.msebera.android.httpclient.impl.conn.PoolingHttpClientConnectionManager#setValidateAfterInactivity(int)}
         */
        @Deprecated
