 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link cz.msebera.android.httpclient.conn.SchemePortResolver} for default port
 * resolution and {@link cz.msebera.android.httpclient.config.Registry} for socket factory lookups.
 */
@Immutable
@Deprecated
