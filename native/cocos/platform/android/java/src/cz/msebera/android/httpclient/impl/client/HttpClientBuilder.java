...
public class HttpClientBuilder {
     ...
     *   cz.msebera.android.httpclient.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   cz.msebera.android.httpclient.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link cz.msebera.android.httpclient.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see cz.msebera.android.httpclient.conn.util.PublicSuffixMatcher
     * @see cz.msebera.android.httpclient.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   cz.msebera.android.httpclient.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * cz.msebera.android.httpclient.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   cz.msebera.android.httpclient.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link cz.msebera.android.httpclient.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link cz.msebera.android.httpclient.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     */
    ...
    /**
     * Assigns a map of {@link cz.msebera.android.httpclient.client.entity.InputStreamFactory}s
     ...
     * @see cz.msebera.android.httpclient.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "cz.msebera.android.httpclient.client", getClass());
            }
        }
