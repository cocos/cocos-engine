...
/**
 * {@link cz.msebera.android.httpclient.conn.util.PublicSuffixMatcher} loader.
 *
 * @since 4.4
 */
@ThreadSafe
                ...
                if (DEFAULT_INSTANCE == null){
                    ...
                    if (url != null) {
                        try {
                            ...
                            // Should never happen
                            final HttpClientAndroidLog log = new HttpClientAndroidLog(PublicSuffixMatcherLoader.class);
