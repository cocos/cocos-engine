...
test('Animation Component', function () {
    ...
    strictEqual(animation.clips.length, 1, 'should add 1 clip');
    ...
    strictEqual(animation.clips.length, 0, 'should remove clip');
...
test('CCAnimation._updateClip', function () {
    ...
    strictEqual(animation.clips.length, 1, 'animation clips length should be 1 after update clip');
    strictEqual(animation.clips[0], newClip, 'animation clips should only include new clip');
    ...
    animation._updateClip(newClip);
    strictEqual(animation.clips.indexOf(newClip), 0, 'clip index should be 0');
