...
test('transform url', function () {
    ...
    result = cc.assetManager._transform({ uuid: '0cbZa5Y71CTZAccaIFluuZ', ext: '.png', isNative: true});
    ...
    result = cc.assetManager._transform({ url: 'www.cocos.com/test.jpg', isNative: true});
