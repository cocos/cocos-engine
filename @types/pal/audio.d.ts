declare module 'pal/audio' {
    ...
    export class InnerAudioPlayer {
         ...
         */
        static load (url: string, opts?: import('cocos/audio/type').AudioLoadOptions): Promise<InnerAudioPlayer>;
         ...
         */
        static loadNative (url: string, opts?: import('cocos/audio/type').AudioLoadOptions): Promise<unknown>;
         ...
         */
        static loadOneShotAudio (url: string, volume: number, opts?: import('cocos/audio/type').AudioLoadOptions): Promise<InnerOneShotAudio>;
         ...
         */
        get type (): import('cocos/audio/type').AudioType;

        /**
         * The state of this player.
         * The state would be restored to `INIT` when the audio finished its playing.
         */
        get state (): import('cocos/audio/type').AudioState;
         ...
         */
        public getPCMData (channelIndex: number): import('cocos/audio/type').AudioPCMDataView | undefined;
