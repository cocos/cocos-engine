if (CC_DEV) {
    var logs = {
        ...
        "3816": "Node '%s' is already activating", //_activateRecursively
        "3817": "Sorry, the component of '%s' which with an index of %s is corrupted! It has been removed.", //_activateRecursive_2
