export default [
  {
    ...
    "techniques": [{"queue":"opaque", "lod":100, "passes":[{"properties":{"color":{"type":17, "value":[1, 1, 1, 1]}, "mainTiling":{"type":14, "value":[1, 1]}, "mainOffset":{"type":14, "value":[0, 0]}, "mainTexture":{"type":29, "value":"grey"}}, "program":"builtin-effect-unlit|unlit-vs:vert|unlit-fs:frag"}]}],
    "shaders": [
      {
  ...
  },
  {
    ...
    "techniques": [{"queue":"opaque-1000", "lod":200, "passes":[{"rasterizerState":{"cullMode":0}, "depthStencilState":{"depthTest":false, "depthWrite":false}, "properties":{"cubeMap":{"type":32, "value":"greyCube"}}, "program":"builtin-effect-skybox|sky-vs|sky-fs"}]}],
    "shaders": [
      {
  ...
  },
  {
    ...
    "techniques": [{"queue":"overlay", "passes":[{"depthStencilState":{"depthTest":true, "depthWrite":false}, "blendState":{"targets":[{"blend":true, "blendSrc":2, "blendDst":4, "blendDstAlpha":4}]}, "properties":{"mainTexture":{"type":29, "value":"grey"}}, "program":"builtin-effect-sprite|sprite-vs:vert|sprite-fs:frag"}]}],
    "shaders": [
      {
