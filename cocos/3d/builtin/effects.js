...
void main() {
  ...
  },
  {
    ...
    "techniques": [{"queue": 0, "lod": 100, "passes": [{"program": "e238b675dacba30ad29961fac06cb18d8c771e16d4fb0f9662acbe3c"}], "priority": 0}],
    ...
    "shaders": [
      {
        ...
        "blocks": [
          {"name": "TexCoords", "defines": ["USE_TEXTURE"], "binding": 0, "size": 16, "members": [
            {"name": "mainTiling", "type": 14, "count": 1},
            {"name": "mainOffset", "type": 14, "count": 1}
          ]},
          {"name": "Constant", "defines": ["USE_COLOR"], "binding": 1, "size": 16, "members": [
