...
export class AnimationController extends Component {
     ...
     * animationController.overrideClips(new Map([ [originalClip, newClip1] ])); // 第一次覆盖
     * animationController.overrideClips(new Map([ [newClip1, newClip2] ])); // 错误：第二次覆盖
     * animationController.overrideClips(new Map([ [originalClip, newClip2] ])); // 正确：第二次覆盖
     * ```
