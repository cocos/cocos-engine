...
import { WebGPUCmdFuncCreateTexture, WebGPUCmdFuncDestroyTexture, WebGPUCmdFuncResizeTexture } from './WebGPU-commands';
import { WebGPUDevice } from './WebGPU-device';
import { IWebGPUGPUTexture } from './WebGPU-gpu-objects';

export class WebGPUTexture extends GFXTexture {
    ...
    public destroy () {
        if (this._gpuTexture) {
            WebGPUCmdFuncDestroyTexture(this._device as WebGPUDevice, this._gpuTexture);
            this._device.memoryStatus.textureSize -= this._size;
