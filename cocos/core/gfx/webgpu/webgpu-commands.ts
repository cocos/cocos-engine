...
export function WebGPUCmdFuncUpdateBuffer (device: WebGPUDevice, gpuBuffer: IWebGPUGPUBuffer, buffer: GFXBufferSource, offset: number, size: number) {
...
export function WebGPUCmdFuncDestroyTexture (device: WebGPUDevice, gpuTexture: IWebGPUGPUTexture) {
...
export function WebGPUCmdFuncDraw (device: WebGPUDevice, drawInfo: GFXDrawInfo) {
    const gl = device.gl;
        ...
        switch (cmd) {
            ...
            */
            ...
            case WebGPUCmd.UPDATE_BUFFER: {
                ...
                WebGPUCmdFuncUpdateBuffer(device, cmd4.gpuBuffer as IWebGPUGPUBuffer, cmd4.buffer as GFXBufferSource, cmd4.offset, cmd4.size);
                break;
            }
