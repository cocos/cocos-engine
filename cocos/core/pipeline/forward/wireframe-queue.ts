...
import { Buffer, BufferInfo, BufferUsageBit, CommandBuffer, InputAssemblerInfo, MemoryUsageBit, PipelineState, PrimitiveMode } from '../../gfx';
    ...
    private _recordCommandBatchedBuffer (device: Device, renderPass: RenderPass, cmdBuff: CommandBuffer) {
        ...
        while (!res.done) {
            ...
            for (let b = 0; b < res.value[0].batches.length; ++b) {
                ...
                cmdBuff.bindDescriptorSet(SetIndex.MATERIAL, this.pass.descriptorSet);
                boundPSO = true;
                // }
