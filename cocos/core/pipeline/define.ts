...
const UNIFORM_SPOT_LIGHTING_MAP_TEXTURE_DESCRIPTOR = new GFXDescriptorSetLayoutBinding(UNIFORM_SPOT_LIGHTING_MAP_TEXTURE_BINDING, GFXDescriptorType.SAMPLER, 1, GFXShaderStageFlagBit.FRAGMENT);
const UNIFORM_SPOT_LIGHTING_MAP_TEXTURE_LAYOUT = new GFXUniformSampler(SetIndex.LOCAL, UNIFORM_SPOT_LIGHTING_MAP_TEXTURE_BINDING, UNIFORM_SPOT_LIGHTING_MAP_TEXTURE_NAME, GFXType.SAMPLER2D, 1);
