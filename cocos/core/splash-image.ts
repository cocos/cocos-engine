...
import { GFXBufferTextureCopy, GFXBufferUsageBit, GFXClearFlag, GFXCommandBufferType, GFXFormat, GFXMemoryUsageBit,
    GFXTextureType, GFXTextureUsageBit, GFXTextureViewType, IGFXRect } from './gfx/define';
...
export class SplashImage {
    ...
    private initPSO () {
        ...
        const program = {
            ...
            techniques: [
                {
                    passes: [{ blendState: { targets: [{ blend: true, blendSrc: 2, blendDst: 4, blendDstAlpha: 4 }] },
