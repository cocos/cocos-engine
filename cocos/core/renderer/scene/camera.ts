...
import { CameraHandle, CameraPool, CameraView, FrustumHandle, FrustumPool, FrustumView } from '../core/memory-pools';
...
export class Camera {
    ...
    private _poolHandle: CameraHandle = 0;
    private _frustumHandle: FrustumHandle = 0;  
    private _ini = false;
