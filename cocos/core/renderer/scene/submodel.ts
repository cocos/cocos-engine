...
export class SubModel {
    ...
    set subMeshData (sm) {
        ...
        if (this._inputAssembler) {
            ...
            this._inputAssembler = (legacyGlobalExports.director.root.device as GFXDevice).createInputAssembler(sm);
        }
    }
    ...
    protected recordCommandBuffer (index: number) {
        const device = legacyGlobalExports.director.root.device as GFXDevice;
