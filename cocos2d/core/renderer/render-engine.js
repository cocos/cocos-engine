    ...
    getState (framebuffer) {
      ...
      for (let y = 0; y < th; y++) {
        for (let x = 0; x < tw; x++) {
          ...
          let deltaColorI = offset + 2 * 4;
          let sizeI = offset + tw * 12;
          let rotI = offset + tw * 12 + 1 * 4;
          let control1I = offset + tw * 12 + 2 * 4;
          let control2I = offset + 2 * tw * 12;
          ...
          let deltaColor = {
            r: rgba[deltaColorI],
            g: rgba[deltaColorI+1],
            b: rgba[deltaColorI+2],
            a: rgba[deltaColorI+3]
          };
