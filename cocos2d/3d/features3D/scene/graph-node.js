cc3d.extend(cc3d, function () {
     ...
     * @property {cc3d.Tags} tags Interface for tagging graph nodes. Tag based searches can be performed using the {@link cc3d.GraphNode#findByTag} function.
     */
    var GraphNode = function GraphNode() {
        this.name = "Untitled"; // Non-unique human readable name
        this.tags = new cc3d.Tags(this);
    ...
    cc3d.extend(GraphNode.prototype, {
         ...
         * @returns {cc3d.GraphNode[]} An array of GraphNodes
         * @example
         ...
         * @returns {cc3d.GraphNode} A single graph node.
         * @example
         ...
         * @returns {cc3d.GraphNode[]} A list of all graph nodes that match the query
         * @example
        ...
        /**
         * @function
         * @name cc3d.GraphNode#findByName
         * @description Get the first node found in the graph with the name. The search
         * is depth first.
         * @param {String} name The name of the graph.
         * @returns {cc3d.GraphNode} The first node to be found matching the supplied name.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphNode#findByPath
         ...
         * @param {String} path The full path of the cc3d.GraphNode.
         * @returns {cc3d.GraphNode} The first node to be found matching the supplied path.
         * @example
        ...
        getPath: function () {
            ...
            if (parent) {
                ...
                while (parent && parent._parent) {
                    path = cc3d.string.format(format, parent.name, path);
                    parent = parent._parent;
                }
         ...
         * @deprecated
         * @function
         * @name cc3d.GraphNode#getRoot
         * @description Get the highest ancestor node from this graph node.
         * @return {cc3d.GraphNode} The root node of the hierarchy to which this node belongs.
         * @example
         ...
         * @deprecated
         * @function
         * @name cc3d.GraphNode#getParent
         * @description Get the parent GraphNode
         * @returns {cc3d.GraphNode} The parent node
         * @example
        ...
        /**
         * @function
         * @name cc3d.GraphNode#isDescendantOf
        ...
        /**
         * @function
         * @name cc3d.GraphNode#isAncestorOf
         ...
         * @deprecated
         * @function
         * @name cc3d.GraphNode#getChildren
         * @description Get the children of this graph node.
         * @returns {cc3d.GraphNode[]} The child array of this node.
         * @example
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getEulerAngles
         ...
         * node, use {@link cc3d.GraphNode#setEulerAngles}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getLocalEulerAngles
         ...
         * {@link cc3d.GraphNode#setLocalEulerAngles}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getLocalPosition
         ...
         * To update the local position, use {@link cc3d.GraphNode#setLocalPosition}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getLocalRotation
         * @description Get the rotation in local space for the specified GraphNode. The rotation
         * is returned as a quaternion. The returned quaternion should be considered read-only.
         * To update the local rotation, use {@link cc3d.GraphNode#setLocalRotation}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getLocalScale
         * @description Get the scale in local space for the specified GraphNode. The scale
         * is returned as a 3-dimensional vector. The returned vector should be considered read-only.
         * To update the local scale, use {@link cc3d.GraphNode#setLocalScale}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getLocalTransform
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getPosition
         ...
         * the world-space position of the graph node, use {@link cc3d.GraphNode#setPosition}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getRotation
         ...
         * to set the world-space rotation of the graph node, use {@link cc3d.GraphNode#setRotation}.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#getWorldTransform
        ...
        /**
         * @function
         * @name cc3d.GraphNode#reparent
         * @description Remove graph node from current parent and add as child to new parent
         * @param {cc3d.GraphNode} parent New parent to attach graph node to
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalEulerAngles
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalEulerAngles^2
         * @description Sets the local space rotation of the specified graph node using euler angles.
         * Eulers are interpreted in XYZ order. Eulers must be specified in degrees.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalPosition
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalPosition^2
         * @description Sets the local space position of the specified graph node.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalRotation
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalRotation^2
         * @description Sets the local space rotation of the specified graph node.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalScale
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setLocalScale^2
         * @description Sets the local space scale factor of the specified graph node.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setPosition
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setPosition^2
         * @description Sets the world space position of the specified graph node.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setRotation
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setRotation^2
         * @description Sets the world space rotation of the specified graph node using
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setEulerAngles
        ...
        /**
         * @function
         * @name cc3d.GraphNode#setEulerAngles^2
         * @description Sets the world space orientation of the specified graph node
         * using Euler angles. Angles are specified in degress in XYZ order.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#addChild
         * @description Add a new child to the child list and update the parent value of the child node
         * @param {cc3d.GraphNode} node The new child to add
         * @example
         * var e = new cc3d.Entity(app);
         ...
         * @deprecated
         * @function
         * @name cc3d.GraphNode#removeLabel
         ...
         * @deprecated
         * @function
         * @name cc3d.GraphNode#findByLabel
         * @description Find all graph nodes from the root and all descendants with the label.
         * @param {String} label The label to search for.
         * @param {cc3d.GraphNode[]} [results] An array to store the results in.
         * @returns {cc3d.GraphNode[]} The array passed in or a new array of results.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphNode#syncHierarchy
        ...
        /**
         * @function
         * @name cc3d.GraphNode#translate^2
         * @description Translates the graph node in world space by the specified translation vector.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#translateLocal
        ...
        /**
         * @function
         * @name cc3d.GraphNode#translateLocal^2
         * @description Translates the graph node in local space by the specified translation vector.
        ...
        /**
         * @function
         * @name cc3d.GraphNode#rotateLocal
        ...
        /**
         * @function
         * @name cc3d.GraphNode#rotateLocal^2
         * @description Rotates the graph node in local space by the specified Euler angles.
         * Eulers are specified in degrees in XYZ order.
