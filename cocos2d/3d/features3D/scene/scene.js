(function () {
    ...
    var enums = {
        ...
        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_NORMAL
         * @description Enable simple translucency for materials such as glass. This is
         * equivalent to enabling a source blend mode of cc3d.BLENDMODE_SRC_ALPHA and a destination
         * blend mode of cc3d.BLENDMODE_ONE_MINUS_SRC_ALPHA.
         */
        BLEND_NORMAL: 2,
        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_NONE
         * @description Disable blending.
         */
        BLEND_NONE: 3,
        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_PREMULTIPLIED
         * @description Similar to cc3d.BLEND_NORMAL expect the source fragment is assumed to have
         * already been multiplied by the source alpha value.
         */
        BLEND_PREMULTIPLIED: 4,
        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_MULTIPLICATIVE
        ...
        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_ADDITIVEALPHA
         * @description Same as cc3d.BLEND_ADDITIVE except the source RGB is multiplied by the source alpha.
         */
        BLEND_ADDITIVEALPHA: 6,

        /**
         * @enum cc3d.BLEND
         * @name cc3d.BLEND_MULTIPLICATIVE2X
    ...
    cc3d.extend(cc3d, enums);

    // For backwards compatibility
    cc3d.scene = {};
    cc3d.extend(cc3d.scene, enums);
}());
...
cc3d.extend(cc3d, function () {
     ...
     * property is only valid if the fog property is set to cc3d.FOG_LINEAR. Defaults to 1000.
     * @property {Number} fogStart The distance from the viewpoint where linear fog begins. This property is
     * only valid if the fog property is set to cc3d.FOG_LINEAR. Defaults to 1.
     * @property {Number} gammaCorrection The gamma correction to apply when rendering the scene. Can be:
     * <ul>
     *     <li>cc3d.GAMMA_NONE</li>
     *     <li>cc3d.GAMMA_SRGB</li>
     *     <li>cc3d.GAMMA_SRGBFAST</li>
     * </ul>
     * Defaults to cc3d.GAMMA_NONE.
     * @property {Number} toneMapping The tonemapping transform to apply when writing fragments to the
     * frame buffer. Can be:
     * <ul>
     *     <li>cc3d.TONEMAP_LINEAR</li>
     *     <li>cc3d.TONEMAP_FILMIC</li>
     * </ul>
     * Defaults to cc3d.TONEMAP_LINEAR.
     * @property {cc3d.Texture} skybox A cube map texture used as the scene's skybox. Defaults to null.
     ...
     * <ul>
     *     <li>cc3d.BAKE_COLOR: single color lightmap
     *     <li>cc3d.BAKE_COLORDIR: single color lightmap + dominant light direction (used for bump/specular)
     * </ul>
    ...
    var Scene = function Scene() {
        ...
        this._gravity = new cc.Vec3(0, -9.8, 0);
        ...
        this.lightmapMode = cc3d.BAKE_COLORDIR;
    ...
    Scene.prototype.updateShadersFunc = function (device) {
        ...
        if (this._skyboxCubeMap && !this._skyboxModel) {
            ...
            material.updateShader = function () {
                ...
                var shader = library.getProgram('skybox', {
                    ...
                    hdr: (scene._skyboxCubeMap.rgbm || scene._skyboxCubeMap.format === cc3d.PIXELFORMAT_RGBA32F),
            ...
            meshInstance.updateKey = function () {
                ...
                this.key = cc3d._getDrawcallSortKey(this.layer, material.blendType, false, 0); // force drawing after all opaque
            };
        ...
        for (i = 0; i < materials.length; i++) {
            var mat = materials[i];
            if (mat.updateShader !== cc3d.Material.prototype.updateShader) {
                mat.clearVariants();
                mat.shader = null;
            }
        }
    ...
    Scene.prototype._updateLightStats = function () {
        ...
        for (var i = 0; i < stats.lights; i++) {
            l = this._lights[i];
            if (l._enabled) {
                if ((l.mask & cc3d.MASK_DYNAMIC) || (l.mask & cc3d.MASK_BAKED)) { // if affects dynamic or baked objects in real-time
                    stats.dynamicLights++;
                }
                if (l.mask & cc3d.MASK_LIGHTMAP) { // if baked into lightmaps
                    stats.bakedLights++;
                }
            }
        }
    ...
    Scene.prototype.addLight = function (light) {
        ...
        if (index !== -1) {
            console.warn("cc3d.Scene#addLight: light is already in the scene");
        } else {
    ...
    Scene.prototype.removeLight = function (light) {
        var index = this._lights.indexOf(light);
        if (index === -1) {
            console.warn("cc3d.Scene#removeLight: light is not in the scene");
        } else {
