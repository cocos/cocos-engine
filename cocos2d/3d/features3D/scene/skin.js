cc3d.extend(cc3d, function () {
     ...
     * @param {cc3d.GraphicsDevice} graphicsDevice The graphics device used to manage this skin.
     ...
     * @param {cc3d.Skin} skin The skin that will provide the inverse bind pose matrices to
    ...
    var SkinInstance = function (skin, node) {
        ...
        if (device.supportsBoneTextures) {
            ...
            this.boneTexture = new cc3d.Texture(device, {
                width: size,
                height: size,
                format: cc3d.PIXELFORMAT_RGBA32F,
                autoMipmap: false
            });
            this.boneTexture.minFilter = cc3d.FILTER_NEAREST;
            this.boneTexture.magFilter = cc3d.FILTER_NEAREST;
