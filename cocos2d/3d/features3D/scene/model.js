cc3d.extend(cc3d, function () {
    ...
    Model.prototype = {
         ...
         * model.
         * @returns {cc3d.Model} A clone of the specified model.
         * @example
        ...
        clone: function () {
            ...
            for (i = 0; i < this.skinInstances.length; i++) {
                ...
                var cloneSkinInstance = new cc3d.SkinInstance(skin, cloneGraph);
            ...
            for (i = 0; i < this.meshInstances.length; i++) {
                ...
                var cloneMeshInstance = new cc3d.MeshInstance(cloneNodes[nodeIndex], meshInstance.mesh, meshInstance.material);
        ...
        /**
         * @function
         * @name cc3d.Model#generateWireframe
         ...
         * cc3d.RENDERSTYLE_WIREFRAME
         * @example
         * model.generateWireframe();
         * for (var i = 0; i < model.meshInstances.length; i++) {
         *     model.meshInstances[i].renderStyle = cc3d.RENDERSTYLE_WIREFRAME;
         * }
         * @author Will Eastcott
         */
        generateWireframe: function () {
            ...
            for (i = 0; i < meshes.length; i++) {
                mesh = meshes[i];
                base = mesh.primitive[cc3d.RENDERSTYLE_SOLID].base;
                count = mesh.primitive[cc3d.RENDERSTYLE_SOLID].count;
                indexBuffer = mesh.indexBuffer[cc3d.RENDERSTYLE_SOLID];
                ...
                wireBuffer = new cc3d.IndexBuffer(indexBuffer.device, cc3d.INDEXFORMAT_UINT16, lines.length);
                dstIndices = new Uint16Array(wireBuffer.lock());
                dstIndices.set(lines);
                wireBuffer.unlock();

                mesh.primitive[cc3d.RENDERSTYLE_WIREFRAME] = {
                    type: cc3d.PRIMITIVE_LINES,
                    base: 0,
                    count: lines.length,
                    indexed: true
                };
                mesh.indexBuffer[cc3d.RENDERSTYLE_WIREFRAME] = wireBuffer;
            }
        }
    };
