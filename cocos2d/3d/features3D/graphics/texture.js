cc3d.extend(cc3d, function () {
     ...
     * @param {cc3d.GraphicsDevice} graphicsDevice The graphics device used to manage this texture.
     * @param {Object} options Object for passing optional arguments.
     * @param {Number} options.width The width of the texture in pixels. Defaults to 4.
     * @param {Number} options.height The height of the texture in pixels. Defaults to 4.
     * @param {Number} options.format The pixel format of the texture. Can be:
     * <ul>
     *     <li>{@link cc3d.PIXELFORMAT_A8}</li>
     *     <li>{@link cc3d.PIXELFORMAT_L8}</li>
     *     <li>{@link cc3d.PIXELFORMAT_L8_A8}</li>
     *     <li>{@link cc3d.PIXELFORMAT_R5_G6_B5}</li>
     *     <li>{@link cc3d.PIXELFORMAT_R5_G5_B5_A1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_R4_G4_B4_A4}</li>
     *     <li>{@link cc3d.PIXELFORMAT_R8_G8_B8}</li>
     *     <li>{@link cc3d.PIXELFORMAT_R8_G8_B8_A8}</li>
     *     <li>{@link cc3d.PIXELFORMAT_DXT1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_DXT3}</li>
     *     <li>{@link cc3d.PIXELFORMAT_DXT5}</li>
     *     <li>{@link cc3d.PIXELFORMAT_RGB16F}</li>
     *     <li>{@link cc3d.PIXELFORMAT_RGBA16F}</li>
     *     <li>{@link cc3d.PIXELFORMAT_RGB32F}</li>
     *     <li>{@link cc3d.PIXELFORMAT_RGBA32F}</li>
     *     <li>{@link cc3d.PIXELFORMAT_ETC1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_PVRTC_2BPP_RGB_1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_PVRTC_2BPP_RGBA_1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_PVRTC_4BPP_RGB_1}</li>
     *     <li>{@link cc3d.PIXELFORMAT_PVRTC_4BPP_RGBA_1}</li>
     * </ul>
     * Defaults to cc3d.PIXELFORMAT_R8_G8_B8_A8.
     ...
     * var texture = new cc3d.Texture(graphicsDevice, {
     *     width: 8,
     *     height: 8,
    ...
    var Texture = function (graphicsDevice, options) {
        ...
        var width = 4;
        var height = 4;
        var format = cc3d.PIXELFORMAT_R8_G8_B8_A8;
        var cubemap = false;
        var rgbm = false;
        ...
        this._format = format;
        this._compressed = (format === cc3d.PIXELFORMAT_DXT1 ||
        format === cc3d.PIXELFORMAT_DXT3 ||
        format === cc3d.PIXELFORMAT_DXT5 ||
        format >= cc3d.PIXELFORMAT_ETC1);

        // Set the new texture to be 4x4 (minimum supported texture size)
        this._width = width || 4;
        this._height = height || 4;

        this._magFilter = cc3d.FILTER_LINEAR;
        this._anisotropy = 1;
        ...
        var pot = cc3d.math.powerOfTwo(this._width) && cc3d.math.powerOfTwo(this._height);
        if (options !== undefined) {
            this._autoMipmap = (options.autoMipmap !== undefined) ? options.autoMipmap : pot;
        } else {
            this._autoMipmap = pot;
        }
        this._addressU = pot ? cc3d.ADDRESS_REPEAT : cc3d.ADDRESS_CLAMP_TO_EDGE;
        this._addressV = this.addressU;
        this._minFilter = pot ? cc3d.FILTER_LINEAR_MIPMAP_LINEAR : cc3d.FILTER_LINEAR;
    };

    // Public properties
    /**
     * @name cc3d.Texture#minFilter
     * @type Number
     * @description The minification filter to be applied to the texture. Can be:
     * <ul>
     *     <li>{@link cc3d.FILTER_NEAREST}</li>
     *     <li>{@link cc3d.FILTER_LINEAR}</li>
     *     <li>{@link cc3d.FILTER_NEAREST_MIPMAP_NEAREST}</li>
     *     <li>{@link cc3d.FILTER_NEAREST_MIPMAP_LINEAR}</li>
     *     <li>{@link cc3d.FILTER_LINEAR_MIPMAP_NEAREST}</li>
     *     <li>{@link cc3d.FILTER_LINEAR_MIPMAP_LINEAR}</li>
     * </ul>
     */
    ...
    Object.defineProperty(Texture.prototype, 'magFilter', {
        ...
        set: function (magFilter) {
            if (!((magFilter === cc3d.FILTER_NEAREST) || (magFilter === cc3d.FILTER_LINEAR))) {
    ...
    /**
     * @name cc3d.Texture#addressU
     * @type Number
     * @description The addressing mode to be applied to the texture. Can be:
     * <ul>
     *     <li>{@link cc3d.ADDRESS_REPEAT}</li>
     *     <li>{@link cc3d.ADDRESS_CLAMP_TO_EDGE}</li>
     *     <li>{@link cc3d.ADDRESS_MIRRORED_REPEAT}</li>
     * </ul>
     */
    ...
    /**
     * @name cc3d.Texture#anisotropy
     * @type Number
     * @description Integer value specifying the level of anisotropic to apply to the texture
     * ranging from 1 (no anisotropic filtering) to the {@link cc3d.GraphicsDevice} property maxAnisotropy.
     */
    ...
    // Public methods
    cc3d.extend(Texture.prototype, {
        /**
         * @private
         * @function
         * @name cc3d.Texture#bind
        ...
        lock: function (options) {
            ...
            options = options || {level: 0, face: 0, mode: cc3d.TEXTURELOCK_WRITE};
            ...
            if (options.mode === undefined) {
                options.mode = cc3d.TEXTURELOCK_WRITE;
            }
        ...
        /**
         * @function
         * @name cc3d.Texture#unlock
         * @description Unlocks the currently locked mip level and uploads it to VRAM.
         */
        unlock: function () {
            cc3d.log.assert(this._lockedLevel !== -1, "Attempting to unlock a texture that is not locked");
        ...
        /**
         * @function
         * @name cc3d.Texture#upload
         * @description Forces a reupload of the textures pixel data to graphics memory. Ordinarily, this function
         * is called by internally by {@link cc3d.Texture#setSource} and {@link cc3d.Texture#unlock}. However, it still needs to
        ...
        getDds: function () {
            if (this.format !== cc3d.PIXELFORMAT_R8_G8_B8_A8)
