(function () {
    ...
    var enums = {
         ...
         * @readonly
         * @type Number
         * @name cc3d.ADDRESS_CLAMP_TO_EDGE
         ...
         * @readonly
         * @type Number
         * @name cc3d.ADDRESS_MIRRORED_REPEAT
        ...
        /**
         * @enum cc3d.CLEARFLAG
         * @name cc3d.CLEARFLAG_COLOR
         * @description Clear the color buffer.
         */
        CLEARFLAG_COLOR: 1,
        /**
         * @enum cc3d.CLEARFLAG
         * @name cc3d.CLEARFLAG_DEPTH
         * @description Clear the depth buffer.
         */
        CLEARFLAG_DEPTH: 2,
        /**
         * @enum cc3d.CLEARFLAG
         * @name cc3d.CLEARFLAG_STENCIL
        ...
        /**
         * @enum cc3d.PRIMITIVE
         * @name cc3d.PRIMITIVE_POINTS
         * @description List of distinct points.
         */
        PRIMITIVE_POINTS: 0,
        /**
         * @enum cc3d.PRIMITIVE
         * @name cc3d.PRIMITIVE_LINES
         * @description Discrete list of line segments.
         */
        PRIMITIVE_LINES: 1,
        /**
         * @enum cc3d.PRIMITIVE
         * @name cc3d.PRIMITIVE_LINELOOP
