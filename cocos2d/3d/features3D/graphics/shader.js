cc3d.extend(cc3d, function () {
     ...
     * @param {cc3d.GraphicsDevice} graphicsDevice The graphics device used to manage this shader.
     * @param {Object} definition The shader definition from which to build the shader.
     * @param {Object} definition.attributes Object detailing the mapping of vertex shader attribute names
     * to semantics (cc3d.SEMANTIC_*). This enables the engine to match vertex buffer data as inputs to the
     * shader.
     ...
     * };
     *
     * shader = new cc3d.Shader(graphicsDevice, shaderDefinition);
    ...
    var Shader = function (graphicsDevice, definition) {
        ...
        if (definition.tag === cc3d.SHADERTAG_MATERIAL) {
            graphicsDevice._shaderStats.materialShaders++;
        }

        // #ifdef PROFILER
        var endTime = cc3d.now();
    ...
    Shader.prototype = {
        link: function () {
            ...
            var _typeToPc = {};
            _typeToPc[gl.BOOL] = cc3d.UNIFORMTYPE_BOOL;
            _typeToPc[gl.INT] = cc3d.UNIFORMTYPE_INT;
            _typeToPc[gl.FLOAT] = cc3d.UNIFORMTYPE_FLOAT;
            _typeToPc[gl.FLOAT_VEC2] = cc3d.UNIFORMTYPE_VEC2;
            _typeToPc[gl.FLOAT_VEC3] = cc3d.UNIFORMTYPE_VEC3;
            _typeToPc[gl.FLOAT_VEC4] = cc3d.UNIFORMTYPE_VEC4;
            _typeToPc[gl.INT_VEC2] = cc3d.UNIFORMTYPE_IVEC2;
            _typeToPc[gl.INT_VEC3] = cc3d.UNIFORMTYPE_IVEC3;
            _typeToPc[gl.INT_VEC4] = cc3d.UNIFORMTYPE_IVEC4;
            _typeToPc[gl.BOOL_VEC2] = cc3d.UNIFORMTYPE_BVEC2;
            _typeToPc[gl.BOOL_VEC3] = cc3d.UNIFORMTYPE_BVEC3;
            _typeToPc[gl.BOOL_VEC4] = cc3d.UNIFORMTYPE_BVEC4;
            _typeToPc[gl.FLOAT_MAT2] = cc3d.UNIFORMTYPE_MAT2;
            _typeToPc[gl.FLOAT_MAT3] = cc3d.UNIFORMTYPE_MAT3;
            _typeToPc[gl.FLOAT_MAT4] = cc3d.UNIFORMTYPE_MAT4;
            _typeToPc[gl.SAMPLER_2D] = cc3d.UNIFORMTYPE_TEXTURE2D;
            _typeToPc[gl.SAMPLER_CUBE] = cc3d.UNIFORMTYPE_TEXTURECUBE;
            ...
            while (i < numAttributes) {
                ...
                var attr = new cc3d.ShaderInput(this.device, this.definition.attributes[info.name], _typeToPc[info.type], location);
            ...
            while (i < numUniforms) {
                ...
                if ((info.type === gl.SAMPLER_2D) || (info.type === gl.SAMPLER_CUBE)) {
                    this.samplers.push(new cc3d.ShaderInput(this.device, info.name, _typeToPc[info.type], location));
                } else {
                    this.uniforms.push(new cc3d.ShaderInput(this.device, info.name, _typeToPc[info.type], location));
                }
            }
