cc3d.extend(cc3d, function () {
    ...
    /**
     * @name cc3d.VertexIterator
     * @class A vertex iterator simplifies the process of writing vertex data to a vertex buffer.
     * @description Returns a new cc3d.VertexIterator object.
     * @param {cc3d.VertexBuffer} vertexBuffer The vertex buffer to be iterated.
    ...
    VertexIterator.prototype = {
        /**
         * @function
         * @name cc3d.VertexIterator#next
         * @description Moves the vertex iterator on to the next vertex.
         * @example
         * var iterator = new cc3d.VertexIterator(vertexBuffer);
         * iterator.element[cc3d.SEMANTIC_POSTIION].set(-0.9, -0.9, 0.0);
         * iterator.element[cc3d.SEMANTIC_COLOR].set(255, 0, 0, 255);
         * iterator.next();
         * iterator.element[cc3d.SEMANTIC_POSTIION].set(0.9, -0.9, 0.0);
         * iterator.element[cc3d.SEMANTIC_COLOR].set(0, 255, 0, 255);
         * iterator.next();
         * iterator.element[cc3d.SEMANTIC_POSTIION].set(0.0, 0.9, 0.0);
         * iterator.element[cc3d.SEMANTIC_COLOR].set(0, 0, 255, 255);
         * iterator.end();
         */
        next: function () {
            var i = 0;
