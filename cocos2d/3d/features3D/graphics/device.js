cc3d.extend(cc3d, function () {
    ...
    function gpuTexSize(gl, tex) {
        if (!_pixelFormat2Size) {
            _pixelFormat2Size = {};
            _pixelFormat2Size[cc3d.PIXELFORMAT_A8] = 1;
            _pixelFormat2Size[cc3d.PIXELFORMAT_L8] = 1;
            _pixelFormat2Size[cc3d.PIXELFORMAT_L8_A8] = 1;
            _pixelFormat2Size[cc3d.PIXELFORMAT_R5_G6_B5] = 2;
            _pixelFormat2Size[cc3d.PIXELFORMAT_R5_G5_B5_A1] = 2;
            _pixelFormat2Size[cc3d.PIXELFORMAT_R4_G4_B4_A4] = 2;
            _pixelFormat2Size[cc3d.PIXELFORMAT_R8_G8_B8] = 4;
            _pixelFormat2Size[cc3d.PIXELFORMAT_R8_G8_B8_A8] = 4;
            _pixelFormat2Size[cc3d.PIXELFORMAT_RGB16F] = 8;
            _pixelFormat2Size[cc3d.PIXELFORMAT_RGBA16F] = 8;
            _pixelFormat2Size[cc3d.PIXELFORMAT_RGB32F] = 16;
            _pixelFormat2Size[cc3d.PIXELFORMAT_RGBA32F] = 16;
        }
        ...
        for (var i = 0; i < mips; i++) {
            ...
            } else if (tex._format === cc3d.PIXELFORMAT_ETC1) {
                size += Math.floor((mipWidth + 3) / 4) * Math.floor((mipHeight + 3) / 4) * 8;
            } else if (tex._format === cc3d.PIXELFORMAT_PVRTC_2BPP_RGB_1 || tex._format === cc3d.PIXELFORMAT_PVRTC_2BPP_RGBA_1) {
                size += Math.max(mipWidth, 16) * Math.max(mipHeight, 8) / 4;
            } else if (tex._format === cc3d.PIXELFORMAT_PVRTC_4BPP_RGB_1 || tex._format === cc3d.PIXELFORMAT_PVRTC_4BPP_RGBA_1) {
                size += Math.max(mipWidth, 8) * Math.max(mipHeight, 8) / 2;
            } else {
                var DXT_BLOCK_WIDTH = 4;
                var DXT_BLOCK_HEIGHT = 4;
                var blockSize = tex._format === cc3d.PIXELFORMAT_DXT1 ? 8 : 16;
    ...
    var GraphicsDevice = function (canvas, options) {
        ...
        if (!window.WebGLRenderingContext) {
            throw new cc3d.UnsupportedBrowserError();
        }
        ...
        if (!this.gl) {
            throw new cc3d.ContextCreationError();
        }
        ...
        (function () {
            ...
            this.defaultClearOptions = {
                ...
                depth: 1,
                stencil: 0,
                flags: cc3d.CLEARFLAG_COLOR | cc3d.CLEARFLAG_DEPTH
            };
            ...
            this.scope = new cc3d.ScopeSpace("Device");

            // Define the uniform commit functions
            this.commitFunction = {};
            this.commitFunction[cc3d.UNIFORMTYPE_BOOL] = function (uniform, value) {
                if (uniform.value !== value) {
                    gl.uniform1i(uniform.locationId, value);
                    uniform.value = value;
                }
            };
            this.commitFunction[cc3d.UNIFORMTYPE_INT] = this.commitFunction[cc3d.UNIFORMTYPE_BOOL];
            this.commitFunction[cc3d.UNIFORMTYPE_FLOAT] = function (uniform, value) {
                if (uniform.value !== value) {
                    gl.uniform1f(uniform.locationId, value);
                    uniform.value = value;
                }
            };
            this.commitFunction[cc3d.UNIFORMTYPE_VEC2] = function (uniform, value) {
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_VEC3] = function (uniform, value) {
                uniformValue = uniform.value;
                scopeX = value[0];
                scopeY = value[1];
                scopeZ = value[2];
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_VEC4] = function (uniform, value) {
                uniformValue = uniform.value;
                scopeX = value[0];
                scopeY = value[1];
                scopeZ = value[2];
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_IVEC2] = function (uniform, value) {
                uniformValue = uniform.value;
                scopeX = value[0];
                scopeY = value[1];
                if (uniformValue[0] !== scopeX || uniformValue[1] !== scopeY) {
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_BVEC2] = this.commitFunction[cc3d.UNIFORMTYPE_IVEC2];
            this.commitFunction[cc3d.UNIFORMTYPE_IVEC3] = function (uniform, value) {
                uniformValue = uniform.value;
                scopeX = value[0];
                scopeY = value[1];
                scopeZ = value[2];
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_BVEC3] = this.commitFunction[cc3d.UNIFORMTYPE_IVEC3];
            this.commitFunction[cc3d.UNIFORMTYPE_IVEC4] = function (uniform, value) {
                uniformValue = uniform.value;
                scopeX = value[0];
                scopeY = value[1];
                scopeZ = value[2];
            ...
            this.commitFunction[cc3d.UNIFORMTYPE_BVEC4] = this.commitFunction[cc3d.UNIFORMTYPE_IVEC4];
            this.commitFunction[cc3d.UNIFORMTYPE_MAT2] = function (uniform, value) {
                gl.uniformMatrix2fv(uniform.locationId, false, value);
            };
            this.commitFunction[cc3d.UNIFORMTYPE_MAT3] = function (uniform, value) {
                gl.uniformMatrix3fv(uniform.locationId, false, value);
            };
            this.commitFunction[cc3d.UNIFORMTYPE_MAT4] = function (uniform, value) {
                gl.uniformMatrix4fv(uniform.locationId, false, value);
            };
            this.commitFunction[cc3d.UNIFORMTYPE_FLOATARRAY] = function (uniform, value) {
                gl.uniform1fv(uniform.locationId, value);
            };

            // Set the initial render state
            this.setBlending(false);
            this.setBlendFunction(cc3d.BLENDMODE_ONE, cc3d.BLENDMODE_ZERO);
            this.setBlendEquation(cc3d.BLENDEQUATION_ADD);
            this.setColorWrite(true, true, true, true);
            this.setCullMode(cc3d.CULLFACE_BACK);
            this.setDepthTest(true);
            this.setDepthWrite(true);
            this.setStencilTest(false);
            this.setStencilFunc(cc3d.FUNC_ALWAYS, 0, 0xFF);
            this.setStencilOperation(cc3d.STENCILOP_KEEP, cc3d.STENCILOP_KEEP, cc3d.STENCILOP_KEEP);
            ...
            this.programLib = new cc3d.ProgramLibrary(this);
            for (var generator in cc3d.programlib) {
                this.programLib.register(generator, cc3d.programlib[generator]);
            }
            ...
            // cc3d.GraphicsDevice.setBoneLimit.
            ...
            this._primsPerFrame = [];
            for (i = cc3d.PRIMITIVE_POINTS; i <= cc3d.PRIMITIVE_TRIFAN; i++) {
            ...
            if (!cc3d._benchmarked) {
                ...
                if (this.extTextureFloatRenderable) {
                    ...
                    tex.minFilter = cc3d.FILTER_NEAREST;
                    tex.magFilter = cc3d.FILTER_NEAREST;
                    tex.addressU = cc3d.ADDRESS_CLAMP_TO_EDGE;
                    tex.addressV = cc3d.ADDRESS_CLAMP_TO_EDGE;
                    var targ = new cc3d.RenderTarget(device, tex, {
                        depth: false
                    });
                    cc3d.drawQuadWithShader(device, targ, test1);

                    var tex2 = new cc3d.Texture(device, {
                        format: cc3d.PIXELFORMAT_R8_G8_B8_A8,
                        width: size,
                        height: size,
                        autoMipmap: false
                    });
                    tex2.minFilter = cc3d.FILTER_NEAREST;
                    tex2.magFilter = cc3d.FILTER_NEAREST;
                    tex2.addressU = cc3d.ADDRESS_CLAMP_TO_EDGE;
                    tex2.addressV = cc3d.ADDRESS_CLAMP_TO_EDGE;
                    var targ2 = new cc3d.RenderTarget(device, tex2, {
                        depth: false
                    });
                    var constantTexSource = device.scope.resolve("source");
                    constantTexSource.setValue(tex);
                    cc3d.drawQuadWithShader(device, targ2, test2);
                ...
                cc3d._benchmarked = true;
            } else {
                this.extTextureFloatRenderable = cc3d.extTextureFloatRenderable;
    ...
    GraphicsDevice.prototype = {
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setViewport
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setScissor
         ...
         * @private
         * @function
         * @name cc3d.GraphicsDevice#getProgramLibrary
         * @description Retrieves the program library assigned to the specified graphics device.
         * @returns {cc3d.ProgramLibrary} The program library assigned to the device.
         */
         ...
         * @private
         * @function
         * @name cc3d.GraphicsDevice#setProgramLibrary
         ...
         * @param {cc3d.ProgramLibrary} programLib The program library to assign to the device.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#updateBegin
         ...
         * with a call to cc3d.GraphicsDevice#updateEnd. Calls to cc3d.GraphicsDevice#updateBegin
         * and cc3d.GraphicsDevice#updateEnd must not be nested.
         */
        updateBegin: function () {
            ...
            if (target) {
                ...
                if (!target._glFrameBuffer) {
                    ...
                    // #ifdef PROFILER
                    this._renderTargetCreationTime += cc3d.now() - startTime;
                    // #endif
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#updateEnd
         * @description Marks the end of a block of rendering. This function should be called
         * after a matching call to cc3d.GraphicsDevice#updateBegin. Calls to cc3d.GraphicsDevice#updateBegin
         * and cc3d.GraphicsDevice#updateEnd must not be nested.
         */
        updateEnd: function () {
            var gl = this.gl;
            ...
            if (target) {
                ...
                var colorBuffer = target._colorBuffer;
                if (colorBuffer._glTextureId && colorBuffer.autoMipmap && cc3d.math.powerOfTwo(colorBuffer._width) && cc3d.math.powerOfTwo(colorBuffer._height)) {
         ...
         * <ul>
         *     <li>cc3d.PRIMITIVE_POINTS</li>
         *     <li>cc3d.PRIMITIVE_LINES</li>
         *     <li>cc3d.PRIMITIVE_LINELOOP</li>
         *     <li>cc3d.PRIMITIVE_LINESTRIP</li>
         *     <li>cc3d.PRIMITIVE_TRIANGLES</li>
         *     <li>cc3d.PRIMITIVE_TRISTRIP</li>
         *     <li>cc3d.PRIMITIVE_TRIFAN</li>
         * </ul>
        ...
        draw: function (primitive, numInstances) {
            ...
            for (i = 0, len = samplers.length; i < len; i++) {
                ...
                if (samplerValue instanceof cc3d.Texture) {
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#clear
         ...
         * combination of:
         * <ul>
         *     <li>cc3d.CLEARFLAG_COLOR</li>
         *     <li>cc3d.CLEARFLAG_DEPTH</li>
         *     <li>cc3d.CLEARFLAG_STENCIL</li>
         * </ul>
         * @example
        ...
        clear: function (options) {
            ...
            if (flags !== 0) {
                ...
                if (flags & cc3d.CLEARFLAG_STENCIL) {
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setRenderTarget
         ...
         * @param {cc3d.RenderTarget} renderTarget The render target to activate.
         * @example
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#getRenderTarget
         * @description Queries the currently set render target on the device.
         * @returns {cc3d.RenderTarget} The current render target.
         * @example
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#getDepthTest
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setDepthTest
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#getDepthWrite
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setDepthWrite
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setColorWrite
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#getBlending
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setBlending
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilTest
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilFunc
         ...
         * <ul>
         *     <li>cc3d.FUNC_NEVER: never pass</li>
         *     <li>cc3d.FUNC_LESS: pass if (ref & mask) < (stencil & mask)</li>
         *     <li>cc3d.FUNC_EQUAL: pass if (ref & mask) == (stencil & mask)</li>
         *     <li>cc3d.FUNC_LESSEQUAL: pass if (ref & mask) <= (stencil & mask)</li>
         *     <li>cc3d.FUNC_GREATER: pass if (ref & mask) > (stencil & mask)</li>
         *     <li>cc3d.FUNC_NOTEQUAL: pass if (ref & mask) != (stencil & mask)</li>
         *     <li>cc3d.FUNC_GREATEREQUAL: pass if (ref & mask) >= (stencil & mask)</li>
         *     <li>cc3d.FUNC_ALWAYS: always pass</li>
         * </ul>
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilFuncFront
         * @description Same as cc3d.GraphicsDevice#setStencilFunc, but only for front faces.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilFuncBack
         * @description Same as cc3d.GraphicsDevice#setStencilFunc, but only for back faces.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilOperation
         ...
         * <ul>
         *     <li>cc3d.STENCILOP_KEEP: don't change the stencil buffer value</li>
         *     <li>cc3d.STENCILOP_ZERO: set value to zero</li>
         *     <li>cc3d.STENCILOP_REPLACE: replace value with the reference value (see cc3d.GraphicsDevice#setStencilFunc)</li>
         *     <li>cc3d.STENCILOP_INCREMENT: increment the value</li>
         *     <li>cc3d.STENCILOP_INCREMENTWRAP: increment the value, but wrap it to zero when it's larger than a maximum representable value</li>
         *     <li>cc3d.STENCILOP_DECREMENT: decrement the value</li>
         *     <li>cc3d.STENCILOP_DECREMENTWRAP: decrement the value, but wrap it to a maximum representable value, if the current value is 0</li>
         *     <li>cc3d.STENCILOP_INVERT: invert the value bitwise</li>
         * </ul>
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilOperationFront
         * @description Same as cc3d.GraphicsDevice#setStencilOperation, but only for front faces.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setStencilOperationBack
         * @description Same as cc3d.GraphicsDevice#setStencilOperation, but only for back faces.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setBlendFunction
         * @description Configures blending operations. Both source and destination
         * blend modes can take the following values:
         * <ul>
         *     <li>cc3d.BLENDMODE_ZERO</li>
         *     <li>cc3d.BLENDMODE_ONE</li>
         *     <li>cc3d.BLENDMODE_SRC_COLOR</li>
         *     <li>cc3d.BLENDMODE_ONE_MINUS_SRC_COLOR</li>
         *     <li>cc3d.BLENDMODE_DST_COLOR</li>
         *     <li>cc3d.BLENDMODE_ONE_MINUS_DST_COLOR</li>
         *     <li>cc3d.BLENDMODE_SRC_ALPHA</li>
         *     <li>cc3d.BLENDMODE_SRC_ALPHA_SATURATE</li>
         *     <li>cc3d.BLENDMODE_ONE_MINUS_SRC_ALPHA</li>
         *     <li>cc3d.BLENDMODE_DST_ALPHA</li>
         *     <li>cc3d.BLENDMODE_ONE_MINUS_DST_ALPHA</li>
         * </ul>
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setBlendEquation
         * @description Configures the blending equation. The default blend equation is
         * cc3d.BLENDEQUATION_ADD.
         * @param {Number} blendEquation The blend equation. Can be:
         * <ul>
         *     <li>cc3d.BLENDEQUATION_ADD</li>
         *     <li>cc3d.BLENDEQUATION_SUBTRACT</li>
         *     <li>cc3d.BLENDEQUATION_REVERSE_SUBTRACT</li>
         * </ul>
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setCullMode
         * @description Controls how triangles are culled based on their face direction.
         * The default cull mode is cc3d.CULLFACE_BACK.
         * @param {Number} cullMode The cull mode to set. Can be:
         * <ul>
         *     <li>cc3d.CULLFACE_NONE</li>
         *     <li>cc3d.CULLFACE_BACK</li>
         *     <li>cc3d.CULLFACE_FRONT</li>
         *     <li>cc3d.CULLFACE_FRONTANDBACK</li>
         * </ul>
         */
        setCullMode: function (cullMode) {
            if (this.cullMode !== cullMode) {
                var gl = this.gl;
                switch (cullMode) {
                    case cc3d.CULLFACE_NONE:
                        gl.disable(gl.CULL_FACE);
                        break;
                    case cc3d.CULLFACE_FRONT:
                        gl.enable(gl.CULL_FACE);
                        gl.cullFace(gl.FRONT);
                        break;
                    case cc3d.CULLFACE_BACK:
                        gl.enable(gl.CULL_FACE);
                        gl.cullFace(gl.BACK);
                        break;
                    case cc3d.CULLFACE_FRONTANDBACK:
                        gl.enable(gl.CULL_FACE);
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setIndexBuffer
         * @description Sets the current index buffer on the graphics device. On subsequent
         * calls to cc3d.GraphicsDevice#draw, the specified index buffer will be used to provide
         * index data for any indexed primitives.
         * @param {cc3d.IndexBuffer} indexBuffer The index buffer to assign to the device.
         */
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setVertexBuffer
         * @description Sets the current vertex buffer for a specific stream index on the graphics
         * device. On subsequent calls to cc3d.GraphicsDevice#draw, the specified vertex buffer will be
         * used to provide vertex data for any primitives.
         * @param {cc3d.VertexBuffer} vertexBuffer The vertex buffer to assign to the device.
        ...
        /**
         * @function
         * @name cc3d.GraphicsDevice#setShader
         * @description Sets the active shader to be used during subsequent draw calls.
         * @param {cc3d.Shader} shader The shader to set to assign to the device.
         */
        ...
        getHdrFormat: function () {
            if (this.extTextureHalfFloatRenderable) {
                return cc3d.PIXELFORMAT_RGB16F;
            } else if (this.extTextureFloatRenderable) {
                return cc3d.PIXELFORMAT_RGB32F;
            }
         ...
         * @private
         * @function
         * @name cc3d.GraphicsDevice#getBoneLimit
         * @description Queries the maximum number of bones that can be referenced by a shader.
         * The shader generators (cc3d.programlib) use this number to specify the matrix array
         ...
         * @private
         * @function
         * @name cc3d.GraphicsDevice#setBoneLimit
    ...
    /**
     * @readonly
     * @name cc3d.GraphicsDevice#width
     * @type Number
    ...
    /**
     * @readonly
     * @name cc3d.GraphicsDevice#height
     * @type Number
    ...
    /**
     * @readonly
     * @name cc3d.GraphicsDevice#maxAnisotropy
     * @type Number
