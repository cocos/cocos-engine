cc3d.programlib.skybox = {
    ...
    createShaderDefinition: function (device, options) {
        ...
        return {
            ...
            fshader: cc3d.programlib.precisionCode(device) +
            ...
            cc3d.programlib.gammaCode(options.gamma) + cc3d.programlib.tonemapCode(options.toneMapping) + chunks.rgbmPS +
