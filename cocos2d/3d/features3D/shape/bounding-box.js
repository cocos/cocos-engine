cc3d.extend(cc3d, function () {
    var tmpVecA = new cc.Vec3();
    var tmpVecB = new cc.Vec3();
    var tmpVecC = new cc.Vec3();
    var tmpVecD = new cc.Vec3();
    var tmpVecE = new cc.Vec3();
    var tmpVecF = new cc.Vec3();

    /**
     * @name cc3d.BoundingBox
     * @description Create a new axis-aligned bounding box
     * @class Axis-Aligned Bounding Box
     * @param {cc.Vec3} center - center of box
     * @param {cc.Vec3} halfExtents - half the distance across the box in each axis
     */
    var BoundingBox = function BoundingBox(center, halfExtents) {
        this.center = center || new cc.Vec3(0, 0, 0);
        this.halfExtents = halfExtents || new cc.Vec3(0.5, 0.5, 0.5);
        this._min = new cc.Vec3();
        this._max = new cc.Vec3();
    };
    ...
    BoundingBox.prototype = {
        ...
        /**
         * @function
         * @name cc3d.BoundingBox#add
         * @description Combines two bounding boxes into one, enclosing both
         * @param {cc3d.BoundingBox} other Bounding box to add
         */
        add: function (other) {
        ...
        clone: function () {
            return new cc3d.BoundingBox(this.center.clone(), this.halfExtents.clone());
        },

        /**
         * @function
         * @name cc3d.BoundingBox#intersects
         * @description Test whether two axis-aligned bounding boxes intersect.
         * @param {cc3d.BoundingBox} other Bounding box to test against
        ...
        /**
         * @function
         * @name cc3d.BoundingBox#getMin
         * @description Return the minimum corner of the AABB.
         * @returns {cc.Vec3} minimum corner
         */
        getMin: function () {
        ...
        /**
         * @function
         * @name cc3d.BoundingBox#getMax
         * @description Return the maximum corner of the AABB.
         * @returns {cc.Vec3} maximum corner
         */
        getMax: function () {
        ...
        /**
         * @function
         * @name cc3d.BoundingBox#containsPoint
         * @description Test if a point is inside a AABB
         * @param {cc.Vec3} point Point to test
        ...
        /**
         * @function
         * @name cc3d.BoundingBox#setFromTransformedAabb
         * @description Set an AABB to enclose the specified AABB if it were to be
         * transformed by the specified 4x4 matrix.
         * @param {cc3d.BoundingBox} aabb Box to transform and enclose
         * @param {cc.Mat4} m Transformation matrix to apply to source AABB.
         */
