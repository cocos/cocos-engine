cc3d.extend(cc3d, function () {
     ...
     * var frustum = new cc3d.Frustum(projectionMatrix, viewMatrix);
    ...
    Frustum.prototype = {
        ...
        /**
         * @function
         * @name cc3d.Frustum#containsPoint
        ...
        /**
         * @function
         * @name cc3d.Frustum#containsSphere
         ...
         * @param {cc3d.BoundingSphere} sphere The sphere to test
