cc3d.extend(cc3d, (function () {
    ...
    var CurveSet = function () {
        ...
        this.curves = [];
        this._type = cc3d.CURVE_SMOOTHSTEP;

        if (arguments.length > 1) {
            for (i = 0; i < arguments.length; i++) {
                this.curves.push(new cc3d.Curve(arguments[i]));
            }
        } else {
            if (arguments.length === 0) {
                this.curves.push(new cc3d.Curve());
            } else {
                var arg = arguments[0];
                if (cc3d.type(arg) === 'number') {
                    for (i = 0; i < arg; i++) {
                        this.curves.push(new cc3d.Curve());
                    }
                } else {
                    for (i = 0; i < arg.length; i++) {
                        this.curves.push(new cc3d.Curve(arg[i]));
                    }
                }
            }
        }
    ...
    CurveSet.prototype = {
        /**
         * @function
         * @name cc3d.CurveSet#get
         * @description Return a specific curve in the curve set.
         * @param {Number} index The index of the curve to return
         * @returns {cc3d.Curve} The curve at the specified index
         */
        get: function (index) {
        ...
        /**
         * @function
         * @name cc3d.CurveSet#clone
         * @description Returns a clone of the specified curve set object.
         * @returns {cc3d.CurveSet} A clone of the specified curve set
         */
        clone: function () {
            var result = new cc3d.CurveSet();
    ...
    /**
     * @name cc3d.CurveSet#type
     * @type Number
     * @description The interpolation scheme applied to all curves in the curve set. Can be:
     * <ul>
     *     <li>cc3d.CURVE_LINEAR</li>
     *     <li>cc3d.CURVE_SMOOTHSTEP</li>
     *     <li>cc3d.CURVE_CATMULL</li>
     *     <li>cc3d.CURVE_CARDINAL</li>
     * </ul>
     */
