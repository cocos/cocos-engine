cc3d.extend(cc3d, (function () {
    ...
    Curve.prototype = {
        ...
        value: function (time) {
            ...
            return cc3d.math.lerp(leftValue, rightValue, interpolation);
        },
        ...
        /**
         * @function
         * @name cc3d.Curve#clone
         * @description Returns a clone of the specified curve object.
         * @returns {cc3d.Curve} A clone of the specified curve
         */
        clone: function () {
            var result = new cc3d.Curve();
            result.keys = cc3d.extend(result.keys, this.keys);
