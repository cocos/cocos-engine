...
export default function () {
    let inPolygon = [new Vec2(417, -312), new Vec2(600, -312), new Vec2(600, 200), new Vec2(554.25, 208.20101039203263), 
        new Vec2(508.5, 228), new Vec2(462.75, 247.79898960796737), new Vec2(417, 256)
    ];
    let expectationConvexPolygons = [ 
        [new Vec2(554.25, 208.20101039203263), new Vec2(462.75, 247.79898960796737), new Vec2(417, 256),new Vec2(417, -312), new Vec2(600, -312)], 
        [new Vec2(554.25, 208.20101039203263), new Vec2(600, -312), new Vec2(600, 200)] 
    ];
