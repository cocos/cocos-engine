...
describe('particle-data-set', () => {
    ...
    test('parameter', () => {
        ...
        expect(() => particles.has(32)).toThrowError();
        expect(() => particles.has(29)).not.toThrowError();
        expect(() => particles.has(-1)).toThrowError();
        ...
        expect(particles.has(customId1)).toBeFalsy();
        expect(particles.has(customId2)).toBeFalsy();
        ...
        expect(particles.has(customId1)).toBeTruthy();
        ...
        expect(particles.has(customId2)).toBeTruthy();
    ...
    test('ensure parameters', () => {
        ...
        expect(particles.has(31)).toBeTruthy();
        expect(particles.has(29)).toBeTruthy();
        expect(particles.has(27)).toBeTruthy();
        expect(particles.has(30)).toBeFalsy();
        expect(particles.has(28)).toBeFalsy();
        ...
        expect(particles.parameterCount).toBe(3);
        expect(particles.has(31)).toBeTruthy();
        expect(particles.has(30)).toBeTruthy();
        expect(particles.has(28)).toBeTruthy();
        expect(particles.has(29)).toBeFalsy();
        expect(particles.has(27)).toBeFalsy();
        ...
        particles.ensureParameters(identities);
        expect(particles.parameterCount).toBe(0);
        expect(particles.has(31)).toBeFalsy();
        expect(particles.has(30)).toBeFalsy();
        expect(particles.has(29)).toBeFalsy();
        expect(particles.has(28)).toBeFalsy();
        expect(particles.has(27)).toBeFalsy();
        ...
        expect(particles.has(28)).toBeFalsy();
        expect(particles.has(27)).toBeFalsy();
        expect(particles.has(1)).toBeFalsy();
        expect(particles.has(2)).toBeFalsy();
        expect(particles.has(3)).toBeFalsy();
    });
