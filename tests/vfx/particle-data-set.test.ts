...
import { ParticleBoolArrayParameter, ParticleColorArrayParameter, ParticleFloatArrayParameter, ParticleParameterIdentity, ParticleUint32ArrayParameter, ParticleVec3ArrayParameter } from '../../cocos/vfx/particle-parameter';
...
describe('particle-data-set', () => {
    ...
    test('particle', () => {
        ...
        particles.addParameter(0, ParticleParameterType.FLOAT);
        particles.addParameter(1, ParticleParameterType.FLOAT);
        ...
        for (let i = 0; i < 76; i++) {
            (parameter0 as ParticleFloatArrayParameter).setFloatAt(i, i);
            (parameter1 as ParticleFloatArrayParameter).setFloatAt(i * 2, i);
        }
        ...
        expect(parameter0?.capacity).toBe(128);
        expect(parameter1?.capacity).toBe(128);
        expect((parameter0 as ParticleFloatArrayParameter).getFloatAt(0)).toBe(75);
        expect((parameter1 as ParticleFloatArrayParameter).getFloatAt(0)).toBe(150);
        for (let i = 1; i < 75; i++) {
            expect((parameter0 as ParticleFloatArrayParameter).getFloatAt(i)).toBe(i);
            expect((parameter1 as ParticleFloatArrayParameter).getFloatAt(i)).toBe(i * 2);
        }
    ...
    test('parameter', () => {
        ...
        expect(() => particles.addParameter(32, ParticleParameterType.FLOAT)).toThrowError();
        expect(() => particles.addParameter(-1, ParticleParameterType.FLOAT)).toThrowError();
        expect(() => particles.getParameter(32)).toThrowError();
        expect(() => particles.getParameter(-1)).toThrowError();
        expect(() => particles.getParameterNoCheck(32)).toThrowError();
        expect(() => particles.getParameterNoCheck(-1)).toThrowError();
        ...
        expect(() => particles.getParameterNoCheck(customId1)).toThrowError();
        expect(() => particles.getParameterNoCheck(customId2)).toThrowError();
        ...
        expect(parameter).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.getParameterNoCheck(customId1)).toBe(parameter);
        expect(() => particles.addParameter(customId1, ParticleParameterType.FLOAT)).toThrowError();
        particles.addParameter(customId2, ParticleParameterType.VEC3);
        ...
        expect(parameter2).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(parameter2).toBe(particles.getParameterNoCheck(customId2));
        ...
        expect(() => particles.addParameter(customId2, ParticleParameterType.VEC3)).toThrowError();
        expect(() => particles.addParameter(customId2, ParticleParameterType.FLOAT)).toThrowError();
        ...
        expect(() => particles.getParameterNoCheck(customId2)).toThrowError();
        particles.reserve(100);
        particles.addParameter(customId1, ParticleParameterType.BOOL);
        expect(particles.parameterCount).toBe(1);
        expect(particles.hasParameter(customId1)).toBeTruthy();
        const parameter3 = particles.getParameter(customId1);
        expect(parameter3).toBeTruthy();
        expect(parameter3).toBeInstanceOf(ParticleBoolArrayParameter);
        expect(parameter3).toBe(particles.getParameterNoCheck(customId1));
        expect(parameter3?.capacity).toBe(100);
        particles.addParameter(customId2, ParticleParameterType.COLOR);
        expect(particles.hasParameter(customId2)).toBeTruthy();
        const parameter4 = particles.getParameter(customId2);
        expect(parameter4).toBeTruthy();
        expect(parameter4).toBeInstanceOf(ParticleColorArrayParameter);
        expect(parameter4).toBe(particles.getParameterNoCheck(customId2));
        expect(parameter4?.capacity).toBe(100);
        expect(particles.parameterCount).toBe(2);
        expect(() => particles.addParameter(customId2, ParticleParameterType.COLOR)).toThrowError();
        expect(() => particles.addParameter(customId2, ParticleParameterType.BOOL)).toThrowError();
    ...
    test('ensure parameters', () => {
        const particles = new ParticleDataSet();
        const identities = [
            new ParticleParameterIdentity(31, 'test', ParticleParameterType.FLOAT),
            new ParticleParameterIdentity(30, 'test2', ParticleParameterType.VEC3),
            new ParticleParameterIdentity(29, 'test3', ParticleParameterType.COLOR),
            new ParticleParameterIdentity(28, 'test4', ParticleParameterType.BOOL),
            new ParticleParameterIdentity(27, 'test5', ParticleParameterType.UINT32),
        ];
        expect(particles.parameterCount).toBe(0);
        ...
        expect(parameter1).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(parameter2).toBeInstanceOf(ParticleColorArrayParameter);
        expect(parameter3).toBeInstanceOf(ParticleUint32ArrayParameter);
        ...
        expect(particles.getParameter(30)).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.getParameter(28)).toBeInstanceOf(ParticleBoolArrayParameter);
    ...
    test('builtin parameter', () => {
        ...
        expect(() => particles.axisOfRotation).toThrowError();
        ...
        expect(particles.position).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.velocity).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.id).toBeInstanceOf(ParticleUint32ArrayParameter);
        expect(particles.randomSeed).toBeInstanceOf(ParticleUint32ArrayParameter);
        expect(particles.color).toBeInstanceOf(ParticleColorArrayParameter);
        expect(particles.size).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.rotation).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.normalizedAliveTime).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.invStartLifeTime).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.baseColor).toBeInstanceOf(ParticleColorArrayParameter);
        expect(particles.baseSize).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.baseVelocity).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.startDir).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.frameIndex).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.isDead).toBeInstanceOf(ParticleBoolArrayParameter);
        expect(particles.axisOfRotation).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.angularVelocity).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.spawnTimeRatio).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.spawnNormalizedTime).toBeInstanceOf(ParticleFloatArrayParameter);
        expect(particles.vec3Register).toBeInstanceOf(ParticleVec3ArrayParameter);
        expect(particles.floatRegister).toBeInstanceOf(ParticleFloatArrayParameter);
    });
