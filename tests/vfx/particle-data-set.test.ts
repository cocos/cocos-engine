...
describe('particle-data-set', () => {
    ...
    test('builtin parameter', () => {
        const particles = new ParticleDataSet();
        expect(particles.parameterCount).toBe(0);
        expect(() => particles.getVec3Parameter(POSITION)).toThrowError();
        expect(() => particles.getVec3Parameter(VELOCITY)).toThrowError();
        expect(() => particles.id).toThrowError();
        expect(() => particles.getUint32Parameter(RANDOM_SEED)).toThrowError();
        expect(() => particles.getColorParameter(COLOR)).toThrowError();
        expect(() => particles.getVec3Parameter(SCALE)).toThrowError();
        expect(() => particles.rotation).toThrowError();
        expect(() => particles.getFloatParameter(NORMALIZED_AGE)).toThrowError();
        expect(() => particles.getFloatParameter(INV_START_LIFETIME)).toThrowError();
        expect(() => particles.baseColor).toThrowError();
        expect(() => particles.getVec3Parameter(BASE_SCALE)).toThrowError();
        expect(() => particles.getVec3Parameter(BASE_VELOCITY)).toThrowError();
        expect(() => particles.getVec3Parameter(INITIAL_DIR)).toThrowError();
        expect(() => particles.subUVIndex).toThrowError();
        expect(() => particles.getFloatParameter(IS_DEAD)).toThrowError();
        expect(() => particles.angularVelocity).toThrowError();
        expect(() => particles.getFloatParameter(SPAWN_TIME_RATIO)).toThrowError();
        expect(() => particles.getFloatParameter(SPAWN_NORMALIZED_TIME)).toThrowError();
        ...
        expect(particles.getVec3Parameter(VELOCITY)).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.id).toBeInstanceOf(Uint32ArrayParameter);
        expect(particles.getUint32Parameter(RANDOM_SEED)).toBeInstanceOf(Uint32ArrayParameter);
        expect(particles.getColorParameter(COLOR)).toBeInstanceOf(ColorArrayParameter);
        expect(particles.getVec3Parameter(SCALE)).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.rotation).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.getFloatParameter(NORMALIZED_AGE)).toBeInstanceOf(FloatArrayParameter);
        expect(particles.getFloatParameter(INV_START_LIFETIME)).toBeInstanceOf(FloatArrayParameter);
        expect(particles.baseColor).toBeInstanceOf(ColorArrayParameter);
        expect(particles.getVec3Parameter(BASE_SCALE)).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.getVec3Parameter(BASE_VELOCITY)).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.getVec3Parameter(INITIAL_DIR)).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.subUVIndex).toBeInstanceOf(FloatArrayParameter);
        expect(particles.getFloatParameter(IS_DEAD)).toBeInstanceOf(BoolArrayParameter);
        expect(particles.angularVelocity).toBeInstanceOf(Vec3ArrayParameter);
        expect(particles.getFloatParameter(SPAWN_TIME_RATIO)).toBeInstanceOf(FloatArrayParameter);
        expect(particles.getFloatParameter(SPAWN_NORMALIZED_TIME)).toBeInstanceOf(FloatArrayParameter);
