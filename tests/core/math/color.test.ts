...
describe('Test Color', () => {
    ...
    test('linearToSrgb', () => {
        ...
        expect(new Color(255, 188, 0, 255).toVec4()).toEqual(new Vec4(1, 0.5028864580325687, 0, 1));
        expect(new Color().fromVec4(new Vec4 (1, 0.5, 0, 1))).toEqual(new Color(255, 188, 0, 255));
    });
});
